...
class DataCenter {
	...
	public function ExecuteQuery($query, $isTable = false)
	{
		try
		{
			...
			echo "QueryOne<br>";
			$qrytwo="SELECT * FROM n_news_news WHERE id >= 527";
			$result2 = mysqli_query($this->conn, $qrytwo) or die("Query Could not Execute Due to " . mysqli_error($this->conn));
			$rowcount=mysqli_num_rows($result2);
			echo $qrytwo."<br>RECORD FOUND:".$rowcount."<br>";
