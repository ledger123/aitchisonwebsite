...
<p><span class="guru"><h2>Apply for Car Stickers</h2><br><a href="car_stickerslist.php"></a></span></p>
...
<input type="text" name="x_request_date" id="x_request_date" value="<?php echo FormatDateTime(@$x_request_date,7); ?>" READONLY>
</span></td>
	</tr>
	<tr>
...
<tr>
	<td><b><u>CHARGES</u></b></td><td></td>
</tr>
<tr>
	<td>1. For the first car sticker Rs.50/- </td><td>Annually</td>
</tr>
	<tr>
...
<tr>
	<td>2. For the second car sticker Rs.100/- </td><td>Annually</td>
</tr>
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">Car Registration#</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
...
<tr>
	<td><b><u>Additional facility for exemption from the car pool system.</td><td><b><u></u></b></td>
</tr>
<tr>
	<td>1  Month             Rs.1000/-</td><td>2  Months                 Rs.2000/-</td>
</tr>
<tr>
	<td>3  Months             Rs.3000/-</td><td>4 Months or above        Rs.5000/-</td>
</tr>
...
<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">Please Select (if you want carpool exemption)</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
<?php
$x_car_pool_periodList = "<select name=\"x_car_pool_period\">";
$x_car_pool_periodList .= "<option value=''>Please Select</option>";
	$x_car_pool_periodList .= "<option value=\"1 Month Rs.1000/-\"";
	if (@$x_car_pool_period == "1 Month Rs.1000/-") {
		$x_car_pool_periodList .= " selected";
	}
	$x_car_pool_periodList .= ">" . "1 Month Rs.1000/-" . "</option>";
	$x_car_pool_periodList .= "<option value=\"2 Months Rs.2000/-\"";
	if (@$x_car_pool_period == "2 Months Rs.2000/-") {
		$x_car_pool_periodList .= " selected";
	}
	$x_car_pool_periodList .= ">" . "2 Months Rs.2000/-" . "</option>";
	$x_car_pool_periodList .= "<option value=\"3 Months Rs.3000/-\"";
	if (@$x_car_pool_period == "3 Months Rs.3000/-") {
		$x_car_pool_periodList .= " selected";
	}
	$x_car_pool_periodList .= ">" . "3 Months Rs.3000/-" . "</option>";
	$x_car_pool_periodList .= "<option value=\"4 Months or above Rs.5000/-\"";
	if (@$x_car_pool_period == "4 Months or above Rs.5000/-") {
		$x_car_pool_periodList .= " selected";
	}
	$x_car_pool_periodList .= ">" . "4 Months or above Rs.5000/-" . "</option>";
...
<tr>
	<td><b><u>School Number of boy(s) using the car</u></b></td><td></td>
</tr>
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">1. School Number</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
<input type="text" name="x_school_num1" id="x_school_num1" size="10" value="<?php echo htmlspecialchars(@$x_school_num1) ?>">
</span></td>
	</tr>
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">2. School Number</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
<input type="text" name="x_school_num2" id="x_school_num2" size="10" value="<?php echo htmlspecialchars(@$x_school_num2) ?>">
</span></td>
	</tr>
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">3. School Number</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
<input type="text" name="x_school_num3" id="x_school_num3" size="10" value="<?php echo htmlspecialchars(@$x_school_num3) ?>">
</span></td>
	</tr>
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">4. School Number</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
<input type="text" name="x_school_num4" id="x_school_num4" size="10" value="<?php echo htmlspecialchars(@$x_school_num4) ?>">
</span></td>
	</tr>
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">5. School Number</span></td>
		<td bgcolor="#F5F5F5"><span class="guru">
...
<tr>
	<td><b>Name of driver/parents/guardian who would be driving cars:</b></td><td></td>
</tr>
...
<tr>
	<td>Note:-</td><td>(1) To be charged in the Fee Bill.</td>
</tr>
<tr>
	<td></td><td>(2) Stickers will be issued from 9th August, 2007.</td>
</tr>
