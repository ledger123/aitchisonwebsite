...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Harkness table</title>
			                    ...
			                    <div class="row">
                                  <div class="col-lg-12 col-md-12 col-sm-12" align="center">
                                    <div id="gallerySLide" class="sgallery_area2">
                                        ...
                                        for($i=1; $i <= 3; $i++){
                                        ?>
                                        <a href="galimages/harkness/<?php echo $i;?>.jpg" title="Harkness Table">
                                          <img class="gallery_img" src="galimages/harkness/small/<?php echo $i;?>.jpg" alt="img" />
