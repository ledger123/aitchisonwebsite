                            ...
                            <div class="x_content">
                                <?php if ( $_SESSION['portal_School'] == "JSD" ) { ?>
                                    <div align="center" class="page-title">
                                        <h3>School Bell Timings</h3>
                                        <div align="center">
											<strong>Commencing from Monday 4<Sup>th</sup> December, 2023</strong>
										</div>
                                        <p>&nbsp;</p>
                                    </div>
									<div class="table-responsive">
                                        <table class="table table-bordered jambo_table" align="center" style="max-width: 700px; width:100%;text-align:center;">
                                            ...
                                            <tr>
                                              <th style="text-align:center;">Classes</th>
                                                <th style="text-align:center;">Timings (Monday to Thursday)</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                              <td>K1, K2 & K3</td>
                                                <td>8:10 AM - 2:20 PM</td>
                                            </tr>
											<tr>
                                              <td>K4, K5 & K6</td>
                                                <td>8:10 AM - 2:30 PM</td>
                                            </tr>	
                                            </tbody>
                                        ...
                                        <p>Upper Primary will follow the date sheet (already uploaded in the GCR) w.e.f. Friday, 8<sup>th</sup> December, 2023.</p>
                              </div>
...
<p>&nbsp;</p><?php */?>
								...
								<div align="center" class="page-title">
                                        ...
                                        <h3 align="center">PREP SCHOOL</h3>

                                        <h4 align="center">Weekly Routine Programme<br>WINTER TERM</h4>
										
                                         <div align="center"><strong>Commencing Thursday, November 2<sup>nd</sup>, 2023 </strong></div> 
                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-bordered jambo_table" style="width: 100%;">
                                                ...
                                                <tr height="20">
                                                    <td height="20" style="height:20px;">5<sup>th</sup> Period (Club &amp; Societies<br/>and Club Sport Lesson 1)</td>
                                                    <td>11:15 a.m.</td>
                                                    <td>11:45 a.m.</td>
                                                </tr>
                                                <tr height="20">
                                                    <td height="20" style="height:20px;">6<sup>th</sup> Period (Club &amp; Societies<br/>and Club Sport Lesson  2)</td>
                                                    <td>11:45 a.m.</td>
                                                    <td>12:15 p.m.</td>
                                                </tr>
                                                </tbody>
                                        ...
                                        <?php if(false) { ?>
                                            ...
                                            <ol style="line-height:1.9;" type="I">
                                                <li>Summer uniform is ‘khaki’ trousers, white full sleeves shirt, grey socks and black college shoes. Summer sports uniform is blue trousers, white full sleeves sports shirt and white college joggers. </li>
                                                <li>On Fridays, however, all students will attend lessons in white ‘shalwar kameez’ and black college shoes and in the last two periods, they will attend mandatory Club &amp; Societies. </li>
                                                <li>Those students who are desirous to take part in Club Sports on Friday must bring in sport kit/uniform in separate bags as specified above.</li>
                                            </ol>
...
<?php */ ?>
                                    ...
                                    elseif ( $_SESSION['portal_School'] == "SSD" ) { ?>
                                        ...
                                        <h4 align="center">WINTER TERM - 2023</h4>

                                        <div align="center"><strong>Commencing from Monday, November 6<sup>th</sup>, 2023</strong></div>
                                        ...
                                        */?>
                                        ...
                                        <?php if(true) { ?>
                                            ...
                                            <ol style="line-height:1.9;">
                                                ...
                                                <li>Winter uniform Grey trouser, white full sleeves shirt, neck tie, grey socks and black college shoes and on Friday White Shalwar Kemeez with Achkan.</li>
												...
												<li>Extra Drill / Academic Detention after School from 2:20 to 3:20 pm.</li>
											    <li>Reporting time for teaching staff is 8:00 am and for MOD is 7:45 am.</li>
                                                <li>No mandatory sports till further notice.</li>
                                            </ol>
