...
$banner_url = $path.'resources/assets/images/banners/school/archive.jpg';
$page_header = $title;
?>
            ...
            <div id="archiverunning" class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div id="MuseumSlide" class="gallery_area" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6" style="margin-top: 15px;">
                                <img src="<?php echo $image_path;?>img/archives/archives-1.jpg" alt="Archives’ Display Centre" class="img-fluid">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6" style="margin-top: 15px;">
                                <img src="<?php echo $image_path;?>img/archives/archives-2.jpg" alt="Archives’ Display Centre" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="StaffGallery" class="gallery_area" style="display: none;">
                        ...
                        <p style="padding-top: 20px;"><img src="<?php echo $image_path;?>img/archives/staff-gallery-20210511.jpg" class="img-fluid" alt="Staff Gallery"></p>
                    </div>
                    <div id="LanglandRoom" class="gallery_area" style="display: none;">
                        ...
                        <p>
                            Enquiries about donations may be made to the Principal's office. &nbsp;<a href="<?php echo $image_path;?>d-one.php" style="color: #07095B; display: contents;"><u>Donate Now</u></a>
                        </p>
                        <p style="padding-top: 20px;">
                            <img src="<?php echo $image_path;?>img/archives/langlands-room-20210511.jpg" class="img-fluid" alt="Langlands' Room">
                        </p>
                    </div>
...
<script type="text/javascript">
    ...
    function showDiv(slidearea) {
        ...
        $("[data-filter='DepartmentSlide']").removeClass('dark');
        $("[data-filter='ContributeSlide']").removeClass('dark');
        ...
        $("[data-filter='" + slidearea + "']").addClass('dark');
