				  ...
				  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
					<div class="x_panel">
					  <div class="x_content">
						  ...
						  <br />
						  <div class="row">
							<form id="formView" action="past-prletters-new.php" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
							...
							foreach($tNews->Rows as $row) {
                                ...
                                if ($row->NewsType == "URL") {
                                    ...
                                    $href = "pletter-new-".$row->NewsId."-".makeSlug($heading);
                            ...
                            <?php
							include("paging.php");
							$url = $portalDomainName . "past-prletters-new.php";
