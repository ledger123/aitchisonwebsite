                            ...
                            <div class="x_content">
                                <?php if ( $_SESSION['portal_School'] == "JSD" ) { ?>
                                    <div align="center" class="page-title">
                                        ...
                                        <div align="center"><strong>Commencing Monday, August 28<Sup>th</Sup>, 2023</strong></div>
                                        <p>&nbsp;</p>
                                    </div>
                                        ...
                                        <table class="table table-bordered jambo_table" align="center" style="max-width: 700px; width:100%;text-align:center;">
                                            ...
                                            <tr>
                                              <th style="text-align:center;">Classes</th>
                                                ...
                                                <th style="text-align:center;">Timings (Friday)</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                              <td>K1, K2 & K3</td>
                                                <td>7:40 AM – 1:10 PM</td>
                                                <td>7:40 AM – 10:50 AM</td>
                                            </tr>
											<tr>
                                              <td>K4, K5 & K6</td>
                                                <td>7:40 AM – 1:20 PM</td>
                                                <td>7:40 AM – 11:00 AM</td>
                                            </tr>	
                                            </tbody>
								...
								<div align="center" class="page-title">
                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-bordered jambo_table" style="width: 100%;">
                                                <tbody>
                                                <tr height="20">
                                                    <td height="20" style="height:20px; width: 50%;"><strong>E2:</strong> Tuesday</td>
                                                    <td>10:15 a.m.</td>
                                                    <td>11:00 a.m.</td>
                                                </tr>
                                                <tr height="20">
                                                    <td height="20" style="height:20px; white-space: nowrap;"><strong>M1:</strong> Wednesday</td>
                                                    <td>10:15 a.m.</td>
                                                    <td>11:00 a.m.</td>
                                                </tr>
                                                <tr height="20">
                                                    <td height="20" style="height:20px;"><strong>M2:</strong>  Thursday</td>
                                                    <td>10:15 a.m.</td>
                                                    <td>11:00 a.m.</td>
                                                </tr>
                                        ...
                                        <?php if(true) { ?>
                                            ...
                                            <ol style="line-height:1.9;">
                                                <li>Summer uniform Khaki trousers, white full sleeves shirt, grey socks and black college shoes</li>
                                                <li>On Fridays, white shalwar kameez and black college shoes</li>
                                                <li>Summer sports uniform blue trousers, white full sleeves sports shirt and white college joggers</li>
                                            </ol>
...
<?php */ ?>
                                    ...
                                    elseif ( $_SESSION['portal_School'] == "SSD" ) { ?>
                                        ...
                                        <div align="center"><strong>Commencing from Monday, August 28<sup>th</sup>, 2023</strong></div>
                                        ...
                                        <?php if(true) { ?>
                                            ...
                                            <ol style="line-height:1.9;">
                                                ...
                                                <li>All boys have to attend mandatory sports sessions once a week, (Monday to Thursday), from C1 to H2 respectively. Off time for that day will be 3:15 pm for them. Cars will be allowed for each year group after 2:50 pm on that particular day and on Friday at 11:00 am for H1 and H2 Parents.</li>
                                            </ol>
