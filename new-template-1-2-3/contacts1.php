...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-12 col-sm-12">
            ...
            <p></p><h4 style="color:#0E064E;"><strong>Postal Address:</strong></h4><p></p>
            ...
            <p></p><h3 style="text-align: center;  color:#0E064E;"><strong>Important email addresses</strong></h3><p></p>
            <div class="table-responsive">
                <table class="table" style="margin-top:20px; border-bottom: 1px solid #ddd;">
                    ...
                    <tr>
                        <td><strong>Director Human Resource:</strong></td><td>hr@aitchison.edu.pk (for general employment)</td>
                    </tr>
                    <tr>
