...
<head>
    ...
    <link href="https://www.dafontfree.net/embed/c2NyaXB0LW10LWJvbGQtcmVndWxhciZkYXRhLzI3L3MvMTQxOTQ5L1NjcmlwdE1UQm9sZC50dGY" rel="stylesheet" type="text/css"/>
    ...
    <style>
        ...
        @font-face {
            ...
            src: url("css/fonts/Freestyle Script Regular.ttf"); format("truetype");
        }

        @font-face {
            font-family:"Roof runners active";
            src: url("css/fonts/jerufb.ttf"); format("truetype");
        }




        .boys-excel-caveat-brush {
            font-family: 'Caveat Brush', cursive;
            top: 40px;
            font-size: 40px;
        }
        .boys-excel-freehand {
            font-family: "Freehand script=latin rev=2";
            top: 80px;
            font-size: 36px;
        }

        .boys-excel-freestyle {
            font-family: Freestyle Script;
            top: 120px;
            font-size: 52px;
        }
        ...
        .boys-excel-script-mt-bold-regular {
            font-family: 'script-mt-bold-regular', sans-serif;
            top: 180px;
            font-size: 36px;
        }


        .boys-excel-merriweather {
            font-family: "Merriweather script=latin rev=2";
            top: 230px;
            font-size: 40px;
        }

        .boys-excel-comic-sans {
        ...
        .boys-excel-roof-runners {
            font-family: "Roof runners active Bold Italic",sans-serif;
            top: 360px;
            font-size: 32px;
        }
    ...
    <div class="dialog-text">
        ...
        <ul style="list-style: none; padding-left: 3px;">
            <marquee behavior="scroll" direction="down" scrollamount="1" onmouseover="this.stop();" onmouseleave="this.start();">
                ...
                <li><a href="newsandevents-live.php?id=988" target="_blank"><h4>&lsquo;Old Boys&rsquo; Bulletin April 2021</h4></a></li>
                ...
                <li><h4>Aitchison U16 cricketers were valiant in defeat in this year's final of the PCB Schools' Cup.</h4></li>

                <li><h4>PTM all schools Oct 15 and 16</h4></li>

                <li><h4>Aitchison Junior National Tennis Titles<br>
                        October 18<sup>th</sup> to 23<sup>rd</sup> at Aitchison Grass Courts</h4></li>
...
<div id="topSection" style="display: none; visibility: collapse;">
    ...
    <nav id="top-navbar" class="hidden-xs">
        <ul style="margin-bottom:0;">
            ...
            <li class="highlightMe"><a href="make-a-gift"><div>Make a Gift</div></a></li>
...
<div id="main-navbar" class="navbar navbar-inverse">
            ...
            <ul id="top-menu" class="nav navbar-nav"<?php echo ($bname=='Safari')?' style="width: 100%;"':'';?>>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="ac-procedure-and-requirements-2021-22.php">Admission Procedure & Requirements For 2021-22</a></li>

                        <li><a href="news-1107-admissions-2022-23">Admissions 2022-23</a></li>
                        ...
                        <li><a href="guide-to-available-seats">A guide to available seats 2022-23</a></li>
                        ...
                        <li><a href="a-level-applications">Admission To A Level And F.Sc<span style="font-size:12px;"> (Pre-Medical)</span> 2021-22</a></li>
                ...
                <li><a href="make-a-gift">Gifts</a></li>
    ...
    <div class="social-icons">
        <ul class="list-inline">
            <li id="school-song" class="list-inline-item"><a href="ac-college-song.php" style="color:orange;" target="_blank" class="active">School Song</a></li>
...
<?php */?>
    ...
    <div class="boys-excel boys-excel-caveat-brush" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>
    <div class="boys-excel boys-excel-freehand" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>
    <div class="boys-excel boys-excel-freestyle" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>

    <div class="boys-excel boys-excel-script-mt-bold-regular" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>

    <div class="boys-excel boys-excel-merriweather" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>

    <div class="boys-excel boys-excel-comic-sans" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>

    <div class="boys-excel boys-excel-playball" style="width: auto;"><span style="margin: 5px;">Where Boys Excel</span></div>
