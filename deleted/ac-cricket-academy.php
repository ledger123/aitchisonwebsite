...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Cricket</title>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
          	<div class="aboutus_area wow fadeInLeft">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <image src="sportsgal/cricket2/5.jpg" alt="" class="img-responsive"/>
                        <p style="font-size:13px;">Aitchison attracts tops coaches for its cricket programme.</p>
                ...
                <div class="row">
                		<div class="col-lg-12  col-lg-offset-1 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-1">
                                <div id="gallerySLide" class="sgallery_area">
                                    ...
                                    for($i=0; $i <= 20; $i ++){
                                    ?>
                                    <a href="sportsgal/cricket-new/<?php echo $i;?>.jpg" title="Cricket">
                                           <img class="gallery_img" src="sportsgal/cricket-new/small/<?php echo $i;?>.jpg" alt="img" />
