...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $path;?>resources/css/photo-gallery.css?v=23">

    <link rel="stylesheet" type="text/css" href="<?php echo $path;?>resources/custom.css?v=34">
