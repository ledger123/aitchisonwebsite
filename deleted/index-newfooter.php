...
<div id="jump-to">
    <ul id="menu_jumpto" class="topmenu" style="width: 0; background-color: transparent;">
            ...
            <div class="submenu" style="width: 360px">
                ...
                <div class="column" style="width:50%">
                    <ul>
                        ...
                        <li><a href="https://aitchison.edu.pk/support/support-college">Support the College</a></li>
                ...
                <div class="column" style="width:50%">
                    <ul>
                        ...
                        <li><a href="https://aitchison.edu.pk/contact-info">Contacts</a></li>
                    </ul>
                </div>
            </div>
        </li>
...
<div class="container-fluid" style="margin-top: -7px;">
    ...
    <div class="row" style="background-color: #abbf6a;">
        <div id="featured-news" class="news-highlights">
            <div class="divider"></div>
            <div class="row ms-3">
                <?php /*?><h6 class="header-top">HEAR STORIES FROM AITCHISON</h6><?php */?>
                <div class="col-8">
    ...
    <div id="sect-boarding" class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12 mb-md-5">
            <?php /*?><h6 class="header-top">EXPERIENCE A HOME FROM HOME</h6><?php */?>
        ...
        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12">
            <div id="boarding-houses" class="owl-carousel owl-theme">
                ...
                <div class="card">
                    <img class="card-img-top" src="resources/assets/images/boarding/8-new1.jpg"/>
                </div>
                <div class="card">
    ...
    <div id="sect-sports" class="row pt-2">
       ...
       <?php /*?> <h6 class="header-top" style="text-align: center;">Success is where preparation and opportunity meet</h6><?php */?>
        <div class="col-12">
