...
<div class="container">
    ...
    <div class="row page-contents">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <p></p><h3>Important email addresses</h3>
            ...
            <div class="" style="margin-bottom: 15px;">
                ...
                <ul class="social-color nav-social mt-2 mb-2 text-start">
                    ...
                    <li><a href="https://www.youtube.com/channel/UCipSn04FP_8tBSyYmXE5WTg/videos" alt="Aitchison College Lahore - Youtube" target="_blank">Youtube</a></li>
                    <li><a href="https://twitter.com/AitchisonColle1" alt="Aitchison College Lahore - Twitter" target="_blank">Twitter</a></li>
                </ul>
