...
$data = $studentLoginRepo->getInactiveStudent($class, $sup_school, $bd, $offset, $recordsPerPage);
//$data = $studentLoginRepo->GetStudentNotLogin($class, '2020-04-01', '2020-04-01 23:59:59', $sup_school, $bd, $offset, $recordsPerPage); 
$totalRecords = $data[0];
//echo "AkhtarRafiq".$totalRecords;
$stdlogdetails = $data[1];
$title="Portal Inactive Students";
					...
					<div class="x_panel">
					  <div class="x_content">
						  ...
						  <div class="row">
						    ...
						    <form id="formView1" action="portal_students_inactive.php" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
							...
							<div class="row form-group">
							 ...
							 <?php if($totalRecords > 0){?>	
								<br><br>  							
							  <form id="formView" action="portal_students_inactive.php" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
							  ...
							  <div class="col-lg-12 col-md-12 col-sm-12 media">
								<?php
								  	$id=1;
									include("paging.php");
									$url = $portalDomainName . "portal_students_inactive.php";
