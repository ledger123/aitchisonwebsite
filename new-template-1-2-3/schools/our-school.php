        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="<?php echo $image_path; ?>/img/our-school-24102017/1.jpg" alt="Image" class="img-fluid" style="width: 100%; margin-top: 10px;">
                    <p style="font-size: small; padding-top: 5px;">H2 Graduating cohort at the Old Building, which is our A2 Level Centre</p>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="<?php echo $image_path; ?>/img/our-school-24102017/5.jpg" alt="Image" class="img-fluid" style="width: 100%; margin-top: 10px;">
