					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						  ...
						  <div class="row" align="right" style="margin: 15px 0;">
							  <p style="padding-bottom: 30px;" align="left">These events are subject to change in the uncertain circumstances of the pandemic.
							  <p>
								  <a href="data/2020-21/important-event-calendar-20200822.pdf" target="_blank" class="active lnkDownload"><span style=""><span class="glyphicon"></span> Download all Important Events </span> </a>
							  </p>
							  <?php /*?><p>
								  <a href="<?php echo Filing::GetURL("", "Important Event Calendar", "../data/2020-21/important-event-calendar-20200822.pdf"); ?>" target="_blank" class="active lnkDownload"><span style=""><span class="glyphicon"></span> Download all Important Events </span> </a>
							  </p><?php */?>
						  </div>
						  <?php }?>
					  </div>
