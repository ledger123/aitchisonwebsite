...
$banner_url = $path.'resources/assets/images/banners/sports-20230221.jpg';
$page_header = $title;
?>
<style>
...
<div class="container">
    ...
    <div class="row page-contents">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <ul style="display: block; list-style-type: disc; margin-before: 1em; margin-after: 1em; margin-start: 0; margin-end: 0; padding-start: 400px; padding: 0 0 0 20px;">
                        ...
                        <li>Synthetic Hockey field and Pavilion</li>
                        ...
                        <li><?php /* 6 Grass, 6 Synthetic and Hard Surface */ ?>18 Tennis Courts</li>
                ...
                <div align="right" class="col-lg-3 col-md-3 col-sm-12" style="border-left: 2px solid #afafaf; padding-right:0px;">
            ...
            <div class="row text-center p-lg-3 p-md-3 p-xs-2">
                <video autoplay="autoplay" controls disablepictureinpicture controlslist="nodownload noplaybackrate"
                       loop="loop" muted="muted" playsinline="playsinline"
                       poster="<?php echo $path; ?>videos/posters/sports-home.jpg"
                       data-object-fit="cover" style="transform: translate3d(0px, 0px, 0px);">
                    <source src="<?php echo $path; ?>videos/sports-home.mp4" type="video/mp4">
