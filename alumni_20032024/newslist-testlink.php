...
$tNews = $newsRepo->GetPublishedNewsForAlumniByLocationId( NewsLocations::AlumniTestLink );
//$tNews->PrintTable();
                ...
                <div class="blog-archive-left">
                  ...
                  <article class="blog-news-single">
                    <div class="blog-news-img" style="height: auto;">
                      <a href="#" onClick="javascript:onViewNews(<?php echo $row->NewsId;?>);"><img src="<?php echo $imagesPath.$row->NewsIcon; ?>" width="640" height="428" alt="<?php echo $row->Subheading; ?>" class="img-responsive"></a>
                    </div>
                    <div class="blog-news-title">
                      <h2><a href="#" onClick="javascript:onViewNews(<?php echo $row->NewsId;?>);"><?php echo $row->Heading; ?></a></h2>
                      <!--<p></p>-->
                      <p><?php echo $row->Subheading; ?></p>
                      <p><!--Time:<a class="blog-author" href="#"> 4 p.m.</a>--> <span class="blog-date">|<?php echo $row->Date; ?></span></p>
                    </div>
...
function onViewNews(id)
{
	...
	window.open("news-testlink.php?id="+id,'_blank');
}
