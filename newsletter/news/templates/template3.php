        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="<?php if ( $news->NewsFor == 1 ) echo 'aboutus_area wow fadeInLeft'; else 'blog-news-details blog-single-details'; ?> ">
                ...
                <?php if ( $news->NewsFor == 1 ) {?>
                    ...
                    <h2 class="titlewithoutborder colorblue hrplace border-blue" style="display: inline-block;"><?php echo $purifier->purify(htmlentities(stripslashes(($news->Heading))) ); ?></h2>
                    <br />
