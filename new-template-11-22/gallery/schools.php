    ...
    <div class="row page-contents">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div id="gallerySLide" class="sgallery_area4">
                ...
                for($i=1; $i <= 12; $i ++){
                    ?>
                    <a href="<?php echo $image_path;?>sportsgal/aboutschools/<?php echo $i;?>.jpg" title="<?php echo $gal_title;?>">
                        <img class="gallery_img" src="<?php echo $image_path;?>sportsgal/aboutschools/small/<?php echo $i;?>.jpg" alt="img" />
