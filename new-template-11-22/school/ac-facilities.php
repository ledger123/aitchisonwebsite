            ...
            <div class="row" style="text-align: center;">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div id="gallerySLide" class="gallery_area">
                        ...
                        <a href="<?php echo $image_path;?>img/facilities/junior-cricket-ground.jpg" title="Junior Cricket Ground">
                            <img class="gallery_img" src="<?php echo $image_path;?>img/facilities/small2/junior-cricket-ground.jpg" alt="Junior Cricket Ground" />
                        ...
                        <a href="<?php echo $image_path;?>img/facilities/basketball-courts-2.jpg" title="Basketball Courts">
                            <img class="gallery_img" src="<?php echo $image_path;?>img/facilities/small2/basketball-courts-2.jpg" alt="img" />
                            <span class="view_btn">Basketball Courts</span>
                        </a>
                        <a href="<?php echo $image_path;?>img/facilities/tennis-court-2.jpg" title="Tennis Courts">
                            <img class="gallery_img" src="<?php echo $image_path;?>img/facilities/small2/tennis-court-2.jpg" alt="img" />
                            <span class="view_btn">Tennis Courts</span>
                        </a>
                        <a href="<?php echo $image_path;?>img/facilities/tennis-court.jpg" title="Tennis Courts">
                            <img class="gallery_img" src="<?php echo $image_path;?>img/facilities/small2/tennis-court.jpg" alt="img" />
                            <span class="view_btn">Tennis Courts</span>
                        </a>
                        ...
                        <a href="<?php echo $image_path;?>img/facilities/jafar-hockey.jpg" title="Jaffar Memorial Hockey Field">
                        ...
                        <a href="<?php echo $image_path;?>img/facilities/chemistry-lab-3.jpg" title="Chemistry Lab">
                            <img class="gallery_img" src="<?php echo $image_path;?>img/facilities/small2/chemistry-lab-3.jpg" alt="img" />
