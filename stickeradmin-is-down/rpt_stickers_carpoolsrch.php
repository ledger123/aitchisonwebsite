...
switch ($sAction)
{
	...
	if ($sSrchStr <> "") {
		ob_end_clean();
		header("Location: rpt_stickers_carpoollist.php" . "?" . $sSrchStr);
		exit();
	}
}
...
<p><span class="guru">Search CUSTOM VIEW: Car Pool Report<br><br><a href="rpt_stickers_carpoollist.php">Back to List</a></span></p>
<form name="rpt_stickers_carpoolsearch" id="rpt_stickers_carpoolsearch" action="rpt_stickers_carpoolsrch.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
button : "cx_request_date" // ID of the button
	...
	<tr>
		<td bgcolor="#666666"><span class="guru" style="color: #FFFFFF;">CarPool Period</span></td>
