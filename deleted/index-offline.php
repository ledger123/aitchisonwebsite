...
<div id="specialDialog" style="" hidden="hidden" title="Important Updates">

    <div class="dialog-text" style="text-align: center;">
        <div style="color:yellow; text-shadow: 1px 1px 2px red; font-weight: bold; font-size: 18px;">2022 APPLICATIONS FOR K1, K2, K4, K5, K6, E2 AND C1 CLOSE NOVEMBER 30, 2021</div>
    </div>
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        //hide the title bar
        $("#specialDialog").siblings('div.ui-dialog-titlebar').remove();
