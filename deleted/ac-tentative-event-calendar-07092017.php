...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison Careers:- Tentative Event Calendar for 2017/2018: RIDING DEPARTMENT </title>
          	...
          	<div class="row">
            	<div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="aboutus_area wow fadeInLeft">
                        <h2 class="titlewithoutborder colorblue hrplace border-blue" style="position: relative; display: inline-block; font-size: 30px;">Tentative Event Calendar for 2017/2018</h2><br><br><br>                        <?php /*?><p align="justify">Tentative Event Calendar for the year 2017/2018 is amended as under please:-</p><br><?php */?>
                   	  <div class="row">
                        	<div class="col-lg-12 col-md-12 col-sm-12">
                            	<table id="maintable" width="100%" border="1" cellspacing="0" cellpadding="0" align="center" class="table table-bordered">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>1.</td>
                                      <td>Inter School/College Show Jumping Competition</td>
                                      <td>PS &amp; SS</td>
                                      <td>15<sup>th</sup> & 16<sup>th</sup> September 2017</td>
                                    </tr>
                                    <tr>
                                      <td>2.</td>
                                      <td>Mian Yousaf Saigol & Col Aslam Niazi Challenge Cups</td>
                                      <td>PS &amp; SS</td>
                                      <td>Saturday, 07<sup>th</sup> October 2017</td>
                                    </tr>
                                    <tr>
                                      <td>3.</td>
                                      <td>Vahali (Dressage & Show Jumps) and Rasulpur Challenge Cups</td>
                                      <td>SS</td>
                                      <td>Saturday, 21<sup>st</sup> October 2017</td>
                                    </tr>
                                    <tr>
                                      <td>4.</td>
                                      <td>Junior School Annual Riding Competition</td>
                                      <td>JS</td>
                                      <td>Saturday, 18<sup>th</sup> November 2017</td>
                                    </tr>
                                    <tr>
                                      <td>5.</td>
                                      <td>Old Boys Vs. College Team Tent Pegging Competition</td>
                                      <td>PS &amp; SS</td>
                                      <td>Saturday, 24<sup>th</sup> February 2018</td>
                                    </tr>
