...
<p>Testing only takes place at Aitchison College during the Admissions period. Each boy must first sit an academic test for his nominated class. <strong>Strict age criteria apply for entrants and no age waivers are granted</strong>. Our intake years for 2017-18 are: Grade 1 (K1) to Grade 10 (C1) for Day and Boarding places. <strong>The College will also offer limited places for boys of outstanding ability based on Cambridge external exams results for entry into H1 or Cambridge AS level. This will be advertised in early July, 2017</strong>. The largest intake is Grade 2 (K2). Grade 1 (K1) is reserved exclusively for boarders from rural and remote areas. In Prep School and Senior School there are a very limited number of places available. By making application to the College, you are also abiding by all its rules, processes and decision-making. </p>

<p><strong>The Admissions process begins on Friday March 24<sup>th</sup>, 2017 when Registration Forms will be available for downloading from the College website. The closing date for applications is Monday April 24<sup>th</sup>, 2017</strong>. Academic testing commences Friday June 2<sup>nd</sup>, 2017 and ends Thursday June 8<sup>th</sup>, 2017.  Testing information and syllabus guidelines are available in our <strong>‘Guide to Admissions Testing’</strong> booklet, which can also be downloaded from the College website. <?php /*?>All students are tested in English, Mathematics and Urdu only.<?php */?> Please refer to our regulations for exemptions in Urdu. </p>

<p>Based on test results, boys are ranked according to cumulative scores in tested subjects and a &lsquo;cut-off&rsquo; applied. Those shortlisted will be called to interview with their parents. Boys will be interviewed by the Principal and other key staff. Should a boy shortlisted not be offered a place, an additional boy&rsquo;s name will be selected from the supplementary list –in strict academic rank order –until the College&rsquo;s Admissions Roll is deemed &lsquo;complete&rsquo; by the Principal. </p>
