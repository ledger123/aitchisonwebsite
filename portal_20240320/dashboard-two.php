							...
							<div class="row top_tiles quick-links">
                                ...
                                <div class="animated flipInY col-lg-2 col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    <a class="tile-stats nav-link " href="calendar" target="_parent">
                                        <i class="fa fa-calendar"></i><div>Calendars 2022-23</div>
                                    </a>

                                </div>


                                <?php if(false && in_array($_SESSION['portal_CurrentClass'], ['C1', 'C2', 'H1', 'H2'])){ ?>
                                <div class="animated flipInY col-lg-2 col-md-3 col-sm-4 col-xs-12">

                                    <a class="tile-stats nav-link " href="monthly-tests-report" style="/*background: rgb(15, 155, 120);*/ font-weight: 500;">
                                        <i class="fa fa-bar-chart"></i><div>Monthly Test Report</div>
                                    </a>
                                ...
                                <?php if(strlen($mockDatesheetTitle) > 0){ ?>
                                <div class="animated flipInY col-lg-2 col-md-3 col-sm-4 col-xs-12">
                                ...
                                <?php if(false && in_array($_SESSION['portal_CurrentClass'], ['K1', 'K2', 'K3', 'K4', 'K5', 'K6', 'M1', 'E2'])){ ?>
                                    <div class="animated flipInY col-lg-2 col-md-3 col-sm-4 col-xs-12">

                                        <a class="tile-stats nav-link " href="new-parents-information" target="_parent"  style="background: rgb(15, 155, 120); font-weight: 500;">
                                            <i class="fa fa-file-pdf-o"></i><div>New Parents 
											<span class="d-none d-sm-block"><br></span>
											Information</div>
                                        </a>
                                ...
                                <?php if (in_array($_SESSION['portal_School'],  ['PSD', 'SSD']) &&
