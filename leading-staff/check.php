<?php
	...
	$page_arr=array(
		...
		"heads-of-department-js-offline"    =>  "headsdepartmentjs_offline.php",
        "co-curricular-head"        =>  "cocurricular_head.php",
        "head-of-discipline-and-welfare"    =>  "head_of_discipline_and_welfare.php",
		"head-of-discipline-and-welfare-offline"    =>  "head_of_discipline_and_welfare_offline.php",
        "head-of-key-annual-events"         =>  "head_of_key_annual_events.php",
		"head-of-key-annual-events-offline"         =>  "head_of_key_annual_events_offline.php",
        "house-heads-ss"         =>  "house_heads_ss.php",
        "house-heads-ps"         =>  "house_heads_ps.php",
        "house-heads-js"         =>  "house_heads_js.php",
		"house-heads-js-offlines" =>  "house_heads_js_offline.php",
