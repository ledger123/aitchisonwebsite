...
<html lang="en">
  <head>
    ...
    <meta name="ROBOTS" content="NOINDEX, NOFOLLOW">
     <title>Aitchison College:- Cyber Security Awareness Newsletter</title>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12" align="center">
                    ...
                    <img src="img/cyber-security-awareness-newsletter.jpg" class="img-responsive" width="100%"><br>
