	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		...
		<div class="tab-content" id="sportsTabContent">
			...
			<div class="tab-pane fade<?php echo ($selectedtab =="tab".$j)?"  show active":"";?>" id="tab<?php echo $j;?>" role="tabpanel" aria-labelledby="tab<?php echo $j;?>-tab">
                ...
                $tNewsContents = $weeklyRepo->GetNewsContents($row->NewsId);
                $tNewsContents = $tNewsContents->Rows[0];
                echo $purifier->purify($functions->replaceQuote($tNewsContents->Content1));
				...
				<div id="gallerySLide<?php echo $j;?>" class="sgallery_area4">
					<?php
						...
						?>
							<a href="<?php echo $purifier->purify("newsletter/news/".$row->FileName2); ?>" title="<?php echo $largeImageTitle; ?>">
								<img class="gallery_img" loading="lazy" src="<?php echo $purifier->purify("newsletter/news/".$row->FileName1); ?>" alt="img" />
