            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 media" style="vertical-align:top;">
                    ...
                    <a href="<?php echo $href; ?>" target="<?php echo $target; ?>" style="text-decoration:none;">
                    	<table>
                        <tr>
                        	<td valign="top"><img style="display: inline-block;vertical-align:top; margin-right:10px; max-height:32px; max-width:150px;" src="img/nl-img150x32.png" height="32" width="150"/></td>
                            <td><div style="display: inline;font-size:18px;"><?php echo (stripslashes(utf8_decode($row->Heading)));?><br />
