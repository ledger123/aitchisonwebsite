<?php
	...
	$banner_image_url="img/pageimages/drama_banner.jpg";
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Drama</title>
            ...
            <div class="row">
            	<div class="col-lg-12  col-lg-offset-1 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-1">
                	<div id="gallerySLide" class="sgallery_area">
                    	<?php
							$titles=array("", "Robin Hood", "GOA", "GOA", "GOA", "Robin Hood", "Drama", "Death of a Salesman", "Unity Night", "Robin Hood" );
                        	for($i=1 ; $i <=9; $i++){
						?>
						<a href="img/drama/<?php echo $i;?>.jpg" title="<?php echo $titles[$i];?>">
                          <img class="gallery_img" src="img/drama/small/<?php echo $i;?>.jpg" alt="<?php echo $titles[$i];?>" />
