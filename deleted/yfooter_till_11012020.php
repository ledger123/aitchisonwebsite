          ...
          <div class="row"> 
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding: 0px;">
				<div class="row aku_logo">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<img src="img/cambridge/cambridge-international-school.png" width="148" height="48" style="vertical-align:top; display:inline; padding-top: 4px;" class="img-responsive" alt="Cambridge International School">	
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12" align="center">
                <div align="center" style="/*padding-top: 10px;*/">            
					...
					<span id="" class="hidden-xs" style="font-size: 11px;">
						<a href="copyrights.php" class="cright"> 2019 © Aitchison College, Lahore. All Rights Reserved.</a></span>
				</div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-3 col-xs-12">
                <div id="cambridge2" class="row">
					  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" s style="padding: 0px; margin: 0px;">
             ...
             <span class="visible-xs" style="font-size: 11px;">
				 <a href="copyrights.php" class="cright">2019 © Aitchison College, Lahore. All Rights Reserved.</a>
             </span>
      </div>
