...
<link href="style_14062019.css?123456" rel="stylesheet">
<?php
...
<?php
}elseif(strpos($_SERVER['REQUEST_URI'], "gallery_all_sports.php")){
?>
<style>
@media (max-width: 767px){
	.sport-gallery-menu{
				  ...
				  <li class="dropdown visible-xs">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="ac-archive.php">Archives</a></li>
                          <li><a href="bog.php">Governors</a></li>
...
?>                    
                ...
                <li><a href="ac-admissions202021.php">Admissions Information</a></li>
                          ...
                          <li><a href="admission-test-timetable-notice-202021.php">Admissions Testing Schedule</a></li><?php */?>

                          <li><a href="ac-principal-news.php?id=761">A Possible Return to School - SOPs</a></li>
                          <li><a href="year-level-new-admissions.php">Year Level New Admissions 2020-21</a></li>
                ...
                <?php /*?><li><a href="request-for-registration-form-2020.php">Request for Registration Form</a></li><?php */?>
					  ...
					  <li><a href="guidance-for-admissions-2020.php">Guidance for Admissions</a></li>
						  ...
						  <li><a href="newsandevents-live.php?id=523">Age Guidelines for 2021-22</a></li>
						  ...
						  <?php /*?>
						    <li><a href="school_doc/admission-2019/admission-process-2019-20.pdf" target="_blank">Admission Process 2019-20</a></li><?php */?>
...
?>
					...
					<li class="dropdown visible-xs"><a href="#" class="dropdown-toggle" role="button" aria-expanded="false">Principal's Newsletters<span class="caret"></span></a>
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="ac-principal_newsletter.php">Most Recent Newsletters</a></li> 
                        <li><a href="ac-ppast_newsletter.php">Principal's Past Newsletters</a></li>
                      </ul>
                    </li>
					...
					<?php } ?>
                    <li><a href="ac-contact-info.php">Contact</a></li>
