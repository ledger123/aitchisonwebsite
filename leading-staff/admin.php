            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        ...
                        <div><strong>Dr. Aftab Ahmad Malik</strong><br>Senior Resident Medical Officer</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        <img src="<?php echo $image_path;?>img/leading-staff/management-committee/dr-naheed-razaq-v2.jpg" alt="" class="img-fluid">
                        <div><strong>Dr. Naheed RazzaK</strong><br>Lady Resident Medical Officer</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        <img src="<?php echo $image_path;?>img/leading-staff/hod-it-v3.jpg" alt="" class="img-fluid">
                        <div><strong>Owais Qadeer</strong><br>Head of IT</div>
                    </div>
                </div>
            </div>
