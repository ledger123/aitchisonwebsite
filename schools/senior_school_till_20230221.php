...
<div class="col-lg-9 col-md-12 col-sm-12">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
			...
			<p style="text-justify: inter-word; ">Senior School ranges in age from 14 to 18 years and prepares boys for Cambridge IGCSE and AS/A Levels, and FBISE or Aga Khan Matric, FSc (pre Med). Each boy is expected to make academics a priority, while still engaging in a full school program. In addition to normal classes,H2 boys (A2 Level) benefit from a special tutorial program in Mathematics and Sciences, approximating a university-styled approach. The College has been a Cambridge Examination Centre since 1933 and is the only school in Pakistan with that distinction. Our teaching is aimed at preparing boys for external assessment across a wide range of subjects, but also inspiring and challenging boys through Harkness Table sessions and Meta-Cognition tutorials run by our Adjunct faculty of distinguished old boys and visiting scholars. We also acknowledge and support individuality within the broader needs of a vibrant and disciplined community. We appreciate that boys possess different talents and interests and we do our best to cater for this with an extensive sporting and co-curricular program that includes over 20 clubs and societies. Sport is compulsory. The College groups its pupils in houses: currently fifteen of which 3 are for boarders and 12 for day boys. Each Head of House is supported by an assistant and general staff who are there to encourage boys and offer sound advice. This system actively underpins a positive and constructive school environment. Boys hold leadership positions as College and School prefects, with a Portfolio Council engaging boys of different ages in managing school life.</p>			</div>
			</div>
            ...
            <div class="mb-5">
				...
				$imgArr = ['17a','1', '2', '14', '3', '4', '16', '5', '6', '7', '8', '9', '10', '11', '12', '13'];
                foreach ($imgArr as $i) { ?>
