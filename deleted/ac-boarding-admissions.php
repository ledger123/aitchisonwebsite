...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Boarding Admissions</title>
      ...
      <div class="container">
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <h2 class="titile">Boarding Admissions</h2>
