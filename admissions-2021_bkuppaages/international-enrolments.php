        ...
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
				...
				<p>Aitchison College offers places each year for international students with preference given to those entering O Levels/IGCSE to A Levels within its <a href="boarding-houses" target="_blank" class="custom">boarding community</a>. This offer would suit foreign or expatriate families with cultural attachments to Pakistan, eager for their sons to acquaint themselves with family, heritage or language, while receiving a top international education. It would also suit families who wish to rekindle historical connections to the Eton of Pakistan. Indeed, boarders enjoy the beauty of one the world’s most outstanding educational environments. Occasionally, we consider places in younger year levels.</p>
				
              
				<br/>
                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                	<img id="imgpr" class="img-responsive image-left" src="img/international-enlorments-20052017/2.jpg">
                    
					<p>As a school renowned world-wide for excellence in residential education for over 130 years, our facilities, systems and educational support are extremely good. Aitchison College has been a Cambridge Examination Centre since 1933 –the only school-based centre in the country. Our academic results are impressive with a high proportion of boys gaining admission to <a href="university-placements" target="_blank" class="custom">top universities</a> in the USA, UK, Canada, Germany and Holland, and here also in Pakistan. On average around 80% of our A Level students gain admission overseas. Among the typical undergraduate courses are: Medicine, Engineering, Law, IT and Programing, Marketing, Economics and Business. Underpinning these outcomes is Aitchison’s own <a href="higher-education-careers" target="_blank" class="custom">University Guidance Department</a> that helps with career and admissions advice, SAT and ACT preparations, and general applications to universities, including UCAS and individual US and other foreign colleges.</p>
                ...
                <div class="row"  style="margin-left: 0px; margin-right: 0px;">
					...
					<p>Our educational program is broad and engaging in <a href="sports" target="_blank" class="custom">sports</a> and <a href="cocurricular" target="_blank" class="custom">co-curricular activities</a> activities, including the <a href="principal-letter-36-aitchison-to-offer-duke-of-edinburgh-international-award" target="_blank" class="custom">Duke of Edinburgh International Award</a>. As such, boarders pursue a balanced and busy school life that also includes time for social activities, special house dinners, as well as excursions into the Old City and the surrounds of Lahore on some weekends. Northern trekking camps are held in July. Our sporting teams regularly travel overseas on tours to the United Kingdom, India, Middle East and Australia. Of particular note, Aitchison has one of the best <a href="riding" target="_blank" class="custom">riding programs</a> in the world. Tent pegging and show jumping are featured events. Older boys may also learn to ride as part of their education under the watchful eyes of trained horseman.</p>
                ...
                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                    ...
                    <img class="img-responsive" src="img/international-enlorments-20052017/5.jpg" alt="" style="width: 100%;max-height:80%;">
                	<br/>
                ...
                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                    ...
                    <p>Our <a href="international-fee" target="_blank" class="custom">International Fee Schedule</a> for the academic year 2019-20 is now available. Fees for Senior, Prep. &amp; Junior are the same.</p>
