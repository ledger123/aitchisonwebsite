					...
					<div class="x_panel">
					  ...
					  <div class="x_content">
						  ...
						  <div class="row" align="right" style="margin: 15px 0;">
                              <p style="padding-bottom: 30px; display: none;" align="left">These events are subject to change in the uncertain circumstances of the pandemic.</p>
							  <p>
								  <a href="<?php echo Filing::GetURL("", "Important Event Calendar", "../data/2021-22/important-event-calendar-20210621.pdf"); ?>" target="_blank" class="active lnkDownload"><span style=""><span class="glyphicon"></span> Download all Important Events </span> </a>
							  </p>
						  </div>
						  <?php }?>
					  </div>
