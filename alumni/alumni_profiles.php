...
<html lang="en">
  ...
  <section id="contact">
     ...
     <div class="row">
      <?php 
	  	$records=$db->selectRecord1("select * from alumnistdprofiles where status='Active' and delstatus ='Not Deleted' order by id DESC");
		//echo count($records);
		if(count($records) > 0){
	  ?> 
        <div class="col-lg-9 col-md-9 col-sm-12">
        	<div class="row">
               ...
               foreach($records as $record){
				   $url="";
				   $url=linkNewsUrl($record['id'], $record['profilename'], "alumniprofile");//"alumni-profile-".$record['id']."-".makeSlug($record['profilename']);
			   ?>
               <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="divarea">
                        <a href="<?php echo $url;?>"><img src="studentpics/<?php echo $record['sypicture'];?>"/></a>
                        <div><a href="<?php echo $url;?>" class="std_name"><?php echo $record['profilename'];?></a></div>
                        <div class="contents">
       ...
       <h4 class="std_name">Where Are You Now?</h4>
       ...
       <p align="justify">Alternatively, you can email us at alumniofficer@aitchison.edu.pk </p>
