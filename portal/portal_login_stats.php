...
$data = $studentLoginRepo->GetStudentLoginStats($class, $from, $to, $sup_school, $bd, $offset, $recordsPerPage);
$totalRecords = $data[0];
					...
					<div class="x_panel">
					  <div class="x_content">
						  ...
						  <div class="row">
						    ...
						    <form id="formView1" action="portal_login_stats.php" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
							...
							<div class="row form-group">
							 ...
							 <?php if($totalRecords > 0){?>	
								<br><br>  							
							  <form id="formView" action="portal_login_stats.php" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
								  ...
								  <table class="table table-bordered table-hover" style="width: 100%;">
								   <thead>
									<tr style="background-color: #4267b2; color: #fff;">
										...
										<th width="12%" align="center"><div align="center">Login</div></th>
										<th width="12%" align="center"><div align="center">Logout</div></th>
									</tr>
								  </thead>	     
									<?php
									  if ( $stdlogdetails )
									  ...
									  ?>
										<tr>
										  ...
										  <td style="text-align: center" nowrap><?php echo date("F d, Y", strtotime($row->LoginTime)); ?><br><?php echo date("g:i A", strtotime($row->LoginTime)); ?>
</td>
										  <td style="text-align: center" nowrap><?php echo date("F d, Y", strtotime($row->LogoutTime)); ?><br><?php echo date("g:i A", strtotime($row->LogoutTime)); ?>
</td>	
							  ...
							  <div class="col-lg-12 col-md-12 col-sm-12 media">
								<?php
								  	$id=1;
									include("paging.php");
									$url = $portalDomainName . "portal_login_stats.php";
