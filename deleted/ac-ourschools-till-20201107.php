<?php
	...
	//$banner_image_url="img/our-school-24102017/banner.jpg";
...
<html lang="en">
 ...
 <div class="row">
   <?php /*?><div class="col-xs-6 col-md-6">
  <img src="img/s3.jpg" alt="Logo" width="350" height="250" class="img-responsive">
  <img src="./img/our-school-24102017/1.jpg" alt="Logo" class="img-responsive" style="width: 350px; height: auto; margin: 25px;">
  
  
  </div>
  
  <div class="col-xs-6 col-md-6">
  <img src="img/s2.jpg" alt="Logo" class="img-responsive" style="width: 350px; height: auto; margin: 25px;">
  </div><?php */?>
   <div class="col-lg-6 col-md-6 col-sm-12">
  <img src="./img/our-school-24102017/1.jpg" alt="Logo" class="img-responsive" style="height: auto; margin-top: 10px;">
  </div>
  <div class="col-lg-6 col-md-6 col-sm-12">
  <img src="./img/our-school-24102017/5.jpg" alt="Logo" class="img-responsive" style="height: auto; margin-top: 10px;">
  </div>
