...
<?php */?>	
			...
			<li class="nav-item btn" role="presentation">
                <button class="nav-link" id="tab0-tab" data-bs-toggle="tab" data-bs-target="#tab0" type="button" role="tab" aria-controls="tab0" aria-selected="<?php echo ($selectedtab =="tab0")?"true":"false";?>" style="width: 100%;height: 100%;vertical-align: middle;"><a href="week-at-a-glance" style="color: inherit;">View Previous...</a></button>
            </li>
        </ul>
