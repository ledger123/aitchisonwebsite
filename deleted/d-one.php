        ...
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input class="form-control" type="number" name="amount" id="amount" min="1" value="<?php echo (count($record_exists) > 0)?$record_exists['amount']:'';?>" style="width:45%;" maxlength="10" placeholder="Enter Amount">					
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-4 text-right">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input required="" type="email" name="email" id="email" class="form-control" value="<?php echo (count($record_exists) > 0)?$record_exists['email']:'';?>" style="width: 45%;">
				</div>
