        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
			...
			<div class="col-sm-12">
				<div class="d-none d-md-block text-center" style="float: right;margin: 0px 0px 0px 30px;max-width: 392px;">
					<img src="<?php echo $image_path;?>img/pageimages/hmps-202208312.jpg" class="rounded" alt="Grand Trunk Road Umballa Cantonment" width="100%">
					<span class="imgtitle">Raja Ashfaq Ahmad<br />Head of Prep School</span>
				</div>
				<div class="d-block d-md-none text-center">
					<img src="<?php echo $image_path;?>img/pageimages/hmps-202208312.jpg" class="rounded" alt="Grand Trunk Road Umballa Cantonment" width="100%">
					<span class="imgtitle">Raja Ashfaq Ahmad<br />Head of Prep School</span>
				</div>
			<p style="text-justify: inter-word; ">Prep School is an inspiring environment for boys who are quickly maturing and eager to express opinions. We aim to set our boys on the path toward being lifelong learners with inquisitive, objective minds. We emphasise mastery of subjects and a strong basis in knowledge and concepts from which to launch into senior studies. Equally, we strive to instill the values of an ethical person; a young gentleman -&nbsp;<em>an Aitchisonian</em>.</p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="d-none">Prep School is an inspiring environment for boys who are quickly maturing and eager to express opinions. We aim to set our boys on the path toward being lifelong learners with inquisitive, objective minds. We emphasise mastery of subjects and a strong basis in knowledge and concepts from which to launch into senior studies. Equally, we strive to instill the values of an ethical person; a young gentleman -&nbsp;<em>an Aitchisonian</em>.</p>
                    <div class="text-center mb-3 d-none">
                        <div class="ms-auto me-auto" style="width: fit-content;">
                            <img src="<?php echo $image_path;?>img/pageimages/hmps-202208312.jpg" class="img-fluid" alt="Image">
                    ...
                    <p class="d-none">Subjects offered at Prep School include: Cambridge core studies in English, Mathematics, Science, added to which are the compulsory studies of Urdu, Islamyiat and Pakistan Studies (History and Geography), Art, and choices of classical and modern languages: Arabic, Persian, Mandarin, German and French. Computer studies is integrated into core subjects. Coding is compulsory and we offer robotics.&nbsp;</p>
