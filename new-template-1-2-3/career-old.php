...
if(empty($_GET['selection']) || mktime(23,59,59,05,31,2023) > time()){
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <ul class="nav nav-tabs mb-3" id="careerTab" role="tablist">
				...
				?>
				<li class="nav-item" role="presentation">
                    <button class="nav-link <?php echo (!empty($_GET['selection']) && $_GET['selection']=="position5-tab")?' active':'';?>" id="position5-tab" data-bs-toggle="tab" data-bs-target="#position5" type="button" role="tab" aria-controls="position5" aria-selected="false">Librarian for Prep School</button>
                </li>
				<?php 
				}
				?>
            ...
            <div class="tab-content" id="careerTabContent" style="display: flex !important;">
				...
				<?php 
				if(mktime(23,59,59,05,31,2023) > time()){
				?>
                <div class="tab-pane fade show <?php echo (!empty($_GET['selection']) && $_GET['selection']=="position5-tab")?' active':'';?>" id="position5" role="tabpanel" aria-labelledby="position5-tab">
					<div class="col-lg-12 col-md-12 col-sm-12">
                        <h4 style="margin-top: 0; margin-bottom: 15px; ">
                            <strong style="color:#800000;">Librarian for Prep School</strong>
                        </h4>
                        <p>We are seeking a Librarian for our Prep School Library (Classes 7 to 9).</p>
					  <p><strong>Qualification:</strong></p>
					    <p style="line-height: 1.6em;">Master's degree in Library Science.</p>
                        <p><strong>Experience:</strong></p>

                        <p style="line-height: 1.6em;">
                        A minimum of 5 Years’ experience as a librarian in any school (related classes). Candidates must have strong literature background, interpersonal skills, and must be fluent in written and spoken English. Applications must reach by 31st May 2023, via email to the Director HR on <span style="color:#0000ff;">hr@aitchison.edu.pk</span></strong>
                        </p>
