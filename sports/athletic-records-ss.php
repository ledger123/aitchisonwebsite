        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="row table-responsive" style="margin: auto; padding: auto; margin-top:22px; max-width: 99%; display: block;">
                <table class="table table-bordered table-striped" style="width:100%">
                    ...
                    <tr style="background-color: #0F0456 !important; color:#FFFFFF; vertical-align: middle;">
                        <th rowspan="2" style="width: 22%; vertical-align: middle;">Events - Senior (16 and over)</th>
            ...
            <div align="center" class="row table-responsive" style="margin: auto; padding: auto; margin-top:22px; max-width: 99%; display: block; ">
                <table align="center" class="table table-bordered table-striped" style="width:100%">
                    <thead>
                    <tr style="background-color: #0F0456 !important; color:#FFFFFF; vertical-align: middle;">
                        <th rowspan="2" style="width: 22%; vertical-align: middle;">Events - Junior (U16)</th>
                        <th colspan="3" style="text-align: center !important; width: 40%;">Present</th>
                    </tr>
                    <tr style="background-color: #0F0456 !important; color:#FFFFFF;">
                        <th style="text-align: center !important; width: 5%;">Year</th>
					...
					<tr>
                        ...
                        <td style="text-align: left; padding-left: 6px; ">11.05 Sec.</td>
                        <td style="text-align: left; padding-left: 6px; ">Bilal Hamid</td>
                    </tr>	
                    <?php /*?><tr>
                        <td style="text-align: left; padding-left: 6px;  ">100 Metres</td>
					...
					<tr>
                        <td style="text-align: left; padding-left: 6px; ">High Jump</td>
                        <td style="text-align: center; padding-left: 6px; ">2023</td>
                        <td style="text-align: left; padding-left: 6px; ">1.68 Metres</td>
                        <td style="text-align: left; padding-left: 6px; ">Nyle Asad Malik</td>
                    </tr>	
                    <?php /*?><tr>
                        <td style="text-align: left; padding-left: 6px; ">High Jump</td>
                        <td style="text-align: center; padding-left: 6px; ">1987</td>
