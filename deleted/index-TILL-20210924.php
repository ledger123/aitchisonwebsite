    ...
    <div class="dialog-text">
        ...
        <ul style="list-style: none; padding-left: 5px;">
            <marquee behavior="scroll" direction="down" scrollamount="1" onmouseover="this.stop();" onmouseleave="this.start();">
                ...
                <li><a href="news-1136-the-opening-of-the-dawood-basketball-centre" target="_blank"><h4>Dawood Basketball Centre Inauguration</h4></a></li>

                <li><a href="news-1137-pcb-schools-cup" target="_blank"><h4>PCB SCHOOLS' CUP<br/>Aitchison cricketers record strong win</h4></a></li>
