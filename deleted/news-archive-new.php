...
else
{
	...
	$data = $newsRepo->GetPublishedNewsByLocationId( NewsLocations::NewsArchive, $offset, $recordsPerPage );
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <div>
              ...
              <form id="form1" method="post" align="right">
                ...
                <?php
					include("newsletter/paging.php");
					$url = $domainName . "news-archive-new.php";
					
					Paging::Draw($page, $totalRecords, $recordsPerPage, $url);
				?>
              </form>
