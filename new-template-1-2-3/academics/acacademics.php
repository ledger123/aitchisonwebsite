        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="col-xs-12 col-md-12">
                <div class="row images">
                    <?php /*?><div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
					...
					<div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/3.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/4.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
					<div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/5.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/6.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
					<div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/7.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/8.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
					<div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/9.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12 col-md-6">
                        <img src="<?php echo $image_path; ?>img/academics/10.JPG" alt="Academics" class="img-fluid" style="width: 100%;">
                    </div>
                </div>
            </div>
            <br><br>
