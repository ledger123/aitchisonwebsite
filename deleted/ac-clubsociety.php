          	...
          	<div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="aboutus_area wow fadeInLeft">
                            <h2 class="titile">Clubs &amp; SociEties</h2>
                           <!-- <p><br><br></p>-->
                    </div>
                </div>
            </div>
            	...
            	<div class="col-lg-12  col-lg-offset-1 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-1">
                	<div id="gallerySLide" class="sgallery_area">
						<?php
                            for($i=1 ; $i <=18; $i++){
                        ?>
                        <a href="img/Clubs-Socities/<?php echo $i;?>.jpg" title="Clubs & Societies">
                          <img class="gallery_img" src="img/Clubs-Socities/small/<?php echo $i;?>.jpg" alt="img" />
