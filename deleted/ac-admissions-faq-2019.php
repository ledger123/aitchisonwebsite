<?php
	...
	header("location: ac-admissions-faq-2020.php");
	exit();
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Admissions FAQs 2019</title>
                        ...
                        <div>
                          <div>
                            <div align="center">
                              ...
                              <h3>FAQs on the Admissions Process 2019</h3>
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div>
                <div>
                  <ol style="padding-left: 20px;">
                    ...
                    <li><strong>Under which years are open for admission in 2019?</strong><?php /*?>Which grades are open for Admissions in 2019?<?php */?></li>
                    <p><?php /*?>Our intake years are normally from Year 1 (K1) to Year 11 (C2) and Year 12 (H1) AS Level. The College will be admitting students into AS Level (Year 12) based on Cambridge external results. All other year levels are by school testing. By far the largest intake is in Year 2 (K2) and Year 7 (E2). Year 1 (K1) is reserved exclusively for boarders from distant or remote areas outside Lahore. Other than K2 and E2, all year level admission numbers are dependent on availability based on returning students.<?php */?>The College will be admitting students into K1 to C2 in 2019. Admissions to H1 (AS Level) will be considered in August when Cambridge results are to hand. All other year levels are by school testing. By far the largest intake is in Year 2 (K2) and Year 7 (E2). Year 1 (K1) is reserved exclusively for boarders from distant or remote areas outside Lahore. All year level admission numbers are dependent on availability based on returning students.</p>
                    <li><strong>How does Aitchison determine the numbers of boys to be admitted?</strong></li>
                    <p>With the approval of the Board of Governors the College reserves the right to offer day or boarding places by category and number according to the on-going availability in each category.This may include a second round offer if places are not filled.</p>
                    ...
                    <p>All queries should be emailed to the Admissions Office at: <a href="mailto:admission2018@aitchison.edu.pk" target="_blank">admission2019@aitchison.edu.pk</a>. </p>
                    ...
                    <p>Applications for registration are available from January 1st, 2019. No applications will be accepted after the closing time and date of 5pm February 1st, 2019.</p>
                    <li><strong>When does testing and interviewing take place?</strong></li>
                    <p>Testing takes place in April.</p>
                    ...
                    <p>Boarding places are for full boarding only. Boys entering Junior School as boarders must board for a minimum of 8 years. Boys entering boarding from Prep School onward must board for the remainder of their time at school.</p>
                    ...
                    <p>No. Boys offered places in full boarding will not be allowed to transfer to weekly boarding or day student status. Because of this boarding places are normally offered to those who could not otherwise attend the College owing to travelling distance. refer 17 above.</p>
                    ...
                    <p>All families will receive notification by letter from the Principal before the end of May.</p>
                    ...
                    <p>No. It is a condition of the Registration process that parents accept the College&rsquo;s decision as final and that results are kept private and test papers remain confidential. This is a ranking exercise for Admissions and not a school test or diagnostic test for public purposes.</p>
                    <li>Interviews also form an essential part of the decision-making process. The Principal will also determine whether an applicant will suit the culture of Aitchison and if he is likely to benefit from a place in boarding or day school.</li> <br>
                    <li>Horse riding is compulsory for all Junior boys. </li>
                  </ol>
                </div>
              </div>
