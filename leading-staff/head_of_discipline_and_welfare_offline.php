    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        <img src="<?php echo $image_path;?>img/leading-staff/discipline-and-welfare/rabbia-kashif.jpg" alt="" class="img-fluid">
                        <div><strong>Rabbia Kashif</strong><br>Junior School<br>Lower Primary</div>
                    </div>
                </div>
            </div>
