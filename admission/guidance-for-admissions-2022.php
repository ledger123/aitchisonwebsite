    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            <ol style="padding-left: 20px; line-height: 1.8; list-style-type: decimal;">
                <li>
                    <p>The application forms for Class C1 & H1/AS level International Boarders are available online. The Application Form with all other admission information can be downloaded from www.aitchison.edu.pk (Admission Section).</p>
                </li>
                <li>
            ...
            <p><strong>THE LAST DATE FOR RECEIPT OF APPLICATION IS: 5.00 P.M. ON FRIDAY 30<sup>tH</sup> JUNE, 2023</strong></p>
            <p></p>
            <br>
