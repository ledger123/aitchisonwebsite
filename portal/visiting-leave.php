...
<?php $title = "Visiting & Leave"; include($path."includes.php"); ?>
					...
					<div class="x_panel">
					  <div class="x_content">
						  <div class="page-title">
							  <h3>Re: Boarders: Visitors and the Granting of Leave</h3>
						  </div>
						  <br />
						  ...
						  <p><strong>No  leave is granted during examination study leave or during examinations without  the Head of School’s approval. Only extreme circumstances would justify this. </strong><br>
						  ...
						  <p>An appropriate leave form will be  signed by all parties. It is crucial that parents also verbally approve boys’  overnight leave requests (not afternoon) and we know who is collecting and  returning the boy or alternatively what the travel arrangements are.</p>
