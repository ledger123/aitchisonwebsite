...
<?php
$title = "Principal's Letter"; include_once ("header-includes.php");
...
<style>
    ...
    .letter-link a:hover .letter-border {
            ...
            if($newsId>0)
            {
                ...
                if(isset($_GET['title']) && makeSlug($row->Heading)===$_GET['title'] ) {
                    ...
                    if ( !isset($_GET['title'])  || isset($_GET['title']) == '') {
                        ...
                        $href = "https://aitchison.edu.pk/new-template-11-22/principal-letter-".$newsId."-".makeSlug($heading);
