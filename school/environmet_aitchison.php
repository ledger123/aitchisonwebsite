...
$title = "Environment of Aitchison"; include_once($path."header-includes.php");

$banner_url = $path.'resources/assets/images/banners/school/aitchison-environment.jpg';
$page_header = $title;
            ...
            <div class="col-md-4 col-sm-12 mb-4">
                <div class="card" data-id="<?php echo $row['Id'] ?>">
                    ...
                    <div class="card-image">
                        <img src="<?php echo $path; ?>resources/assets/aitchison-env/images/<?php echo $row['Id'] ?>.jpg" alt="News" class="img-fluid" loading="lazy">
                    </div>
...
<script>
    ...
    $('.card').click(function() {
        ...
        let src = "<?php echo $path; ?>resources/assets/aitchison-env/images/";
        if($(window).width() > 426) {
            src += data_id +  "-lg.jpg";
        }
        else {
        ...
        $.ajax({
        url: '<?php echo $path; ?>environment-data',
        type: 'GET',
        data: 'id='+data_id,
        dataType: 'JSON',
