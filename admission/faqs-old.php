...
$title = "FAQs on the Admissions Process"; include_once($path."header-includes.php");
...
$faqs[] = ['q' => "How does one apply for Admissions?",
    'a' => "Download the Application form from the College website available from June 1, 2021 and return with the requested Registration fee with the application and all supporting documents within the due date November 30, 2021. The invitation for Admissions will be published in all major newspapers of Pakistan."];
...
$faqs[] = ['q' => "Which grades are open for Admissions?",
    'a' => "Our intake years are from Year 1 (K1 ), K2, K4, K5, K6 and Year 7 (E2). The College may decide to admit students into C1 (Aga Khan Matric), A Level (Year 12) and Aga Khan FSc/FA based on external results. By far the largest intake is in Year 2 (K2) and Year 7 (E2). Year 1 (K1) is reserved exclusively for boarders from distant or remote areas."];
...
$faqs[] = ['q' => "Who can answer enquiries on Admissions?",
    'a' => "All queries should be emailed to the Admissions  Office at: <span style='color: blue;'>admission2022@aitchison.edu.pk</span>."];
