...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Arts and Science Exhibition 2017</title>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12" align="center">
                    <div id="gallerySLide" class="sgallery_area">
                        <?php
                        $small_imgtitle="Arts & Science Exhibition";
                        $large_imgtitle="Arts and Science Exhibition 2017";
                        for($i=1; $i <= 9; $i++) {
                        ?>
                            <a href="galimages/arts-science-exhibition-21032017/<?php echo $i;?>.jpg" title="<?php echo $large_imgtitle;?>">
                              <img class="gallery_img" src="galimages/arts-science-exhibition-21032017/small/<?php echo $i;?>.jpg" alt="img" />
