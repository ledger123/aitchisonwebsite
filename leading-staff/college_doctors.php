...
<div class="col-lg-9 col-md-12 col-sm-12">
    ...
    <div class="row">
        ...
        <!-- Left Area -->
        <div class="col-lg-9 col-md-12 col-sm-12">
            <h2 class="titile">College Doctors</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        <img src="<?php echo $image_path;?>img/leading-staff/management-committee/dr-naheed-razaq-v1.jpg" alt="" class="img-fluid">
                        <div><strong>Dr. Naheed Razzaq</strong><br>Lady Resident Medical Officer</div>
                    </div>
                </div>
            </div>
        </div>
