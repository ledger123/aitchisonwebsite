...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Environment</title>
            ...
            <div class="row">
            	<div class="col-lg-12  col-lg-offset-1 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-1">
                	<div id="gallerySLide" class="sgallery_area">
						<a href="img/environment/main_new/bee-club-1.jpg" title="Bee Club">
                          <img class="gallery_img" src="img/environment/main_new/small/bee-club-1.jpg" alt="Bee Club" />
                          <span class="view_btn">Bee Club</span>
                        </a>
						<a href="img/environment/main_new/bee-club-2.jpg" title="Bee Club">
                          <img class="gallery_img" src="img/environment/main_new/small/bee-club-2.jpg" alt="Bee Club" />
                          <span class="view_btn">Bee Club</span>
                        </a>
						<?php
                        for($i= 1; $i <= 24; $i++){
                        ?>
                        <a href="img/environment/main_new/<?php echo $i;?>.jpg" title="Aitchison's Environment">
                          <img class="gallery_img" src="img/environment/main_new/small/<?php echo $i;?>.jpg" alt="Aitchison's Environment" />
