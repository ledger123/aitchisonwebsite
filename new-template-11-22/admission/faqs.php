...
$title = "FAQs on the Admissions Process 2023-24"; include_once($path."header-includes.php");
$page_header = $title;
...
$faqs[] = ['q' => "How does one apply for Admissions?",
    'a' => "Download the Application form from the College website available from October 1, 2022 and return with the requested Registration fee with the application and all supporting documents within the due date November 30, 2022. The invitation for Admissions will be published in all major newspapers of Pakistan."];
...
$faqs[] = ['q' => "Which grades are open for Admissions?",
    'a' => "Our intake years are from Year 1 (K1 ), K2 and Year 7 (E2). The College may decide to admit students into C1 (Aga Khan Matric), A Level (Year 12) and Aga Khan FSc based on external results. By far the largest intake is in Year 2 (K2) and Year 7 (E2). Year 1 (K1) is reserved exclusively for boarders from distant or remote areas."];
...
$faqs[] = ['q' => "When will information be made available to families on whether their son has been successful or unsuccessful?",
    'a' => "All families will receive notification by letter from the Principal before the end of April 2023."];
