...
<html lang="en">
  ...
  <section id="contact">
	 ...
	 <p align="justify" style="margin-top:0px;">
     	You may send us an email at <a href="mailto:alumniofficer@aitchison.edu.pk">alumniofficer@aitchison.edu.pk</a> or call us on +92-42-36363063 (Ext: 427). Also, please fill out our <a href="alumni_registration.php">alumni registration form</a>, so that we may update contact information.
     </p>
               ...
               <?php 
					...
					if ($_POST['btnSSubmit']) {
						...
						if ($resp) {
							...
							{
								echo "<div class='alert alert-danger' role='alert' style='width:310px;'>
							...
							elseif ($name=="") {
								...
								$subject="Message from Overseas Alumni contact form"; 
								mail("fahadiqbal@aitchison.edu.pk", $subject, $message, $from); 
								//mail("web@aitchison.edu.pk", $subject, $message, $from); 
								//echo "Email sent!";
								
								echo "<div class='alert alert-success' role='alert' style='width:310px;'>
								  Email sent!
								</div>";
							...
							//echo $login_msg="Sorry! You have entered Wrong varification code. please fill the form again.";
							echo "<div class='alert alert-danger' role='alert' style='width:310px;'>
								  Sorry! You have entered Wrong varification code.
								</div>";
					...
					if (!$response)    /* display the contact form */ 
					{ 
						?> 
						<form  action="" method="POST" enctype="multipart/form-data"> 
						<input type="hidden" name="action" value="submit"> 
						Your name:<br> 
						<input name="name" type="text" class="form-control" required value="<?php echo $name;?>" size="36"/><br> 
						Your email:<br> 
						<input name="email" type="text" class="form-control" required value="<?php echo $email;?>" size="36"/><br> 
						Your message:<br> 
						<textarea name="message" rows="7" cols="36" class="form-control" required><?php echo $message;?></textarea><br> 
                        ...
                        <div align="left" style="margin-top:15px;">
                            ...
                            <input type="text" name="captcha" id="captcha" autocomplete="off" style="margin:16px 0px;" placeholder="Enter verification code" class="form-control" required size="4">
                        </div>
                        <br>
