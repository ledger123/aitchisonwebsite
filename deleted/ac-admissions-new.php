...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Admissions</title>
      ...
      <div class="container">
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <h2 class="titile">Admissions</h2>
            <p>Aitchison College Entrance Tests are now complete. Successful and unsuccessful candidates have been notified by letter.</p>
            <p>We take this opportunity to thank all families for their interest in the College. Information on testing for the academic year 2017-2018 should be made available in December 2016. </p>
            <p></p>
            <div class="row">
              <div class="col-lg-offset-2 col-lg-7 col-xs-offset-2 col-md-8 col-sm-12">
                	 <h3> <span style="font-weight: bold; font-size: 20px; text-align: center;">Age Guidelines for Admission 2016</span> </h3>	
                       <table border="1" cellspacing="0" cellpadding="0" align="center" class="table table-bordered" width="100%" id="tbl">
                            <tbody>
                              <tr class="success1">
                                <th width="20%" scope="col">Year Level</th>
                                <th width="80%" scope="col">Date of Birth</th>
                              </tr>
                              <tr>
                                <td align="center">K1</td>
                                <td>June 1, 2010 – May 31, 2011 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">K2</td>
                                <td>June 1, 2009 – May 31, 2010 inclusive</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>June 1, 2007 – May 31, 2008 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">K5</td>
                                <td>June 1, 2006 – May 31, 2007 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">E1</td>
                                <td>June 1, 2005 – May 31, 2006 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">E2</td>
                                <td>June 1, 2004 – May 31, 2005 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">M1</td>
                                <td>June 1, 2003 – May 31, 2004 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">M2</td>
                                <td>June 1, 2002 – May 31, 2003 inclusive</td>
                              </tr>
                              <tr>
                                <td align="center">C1</td>
                                <td>June 1, 2001 – May 31, 2002 inclusive</td>
                              </tr>
                            </tbody>
                          </table>
                </div>
