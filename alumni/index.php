              ...
              <ul class="course_nav">
                <li>
                  ...
                  <li>
                      <div class="single_course">
                          <div class="singCourse_imgarea">
                              <img src="./img/founders-day-2023.jpg" alt="NEWS AND EVENTS" />
                              <div class="mask">
                                  <a href="news-bulletin" class="course_more" target="_blank"> NEWS AND EVENTS </a>
                              </div>
                          </div>
                          <div class="singCourse_content">
                              <h3 class="singCourse_title"><a href="news-bulletin" target="_blank">NEWS AND EVENTS</a></h3>
                              <p class="hidden-xs"></p>
                          </div>
                          <div class="singCourse_author hidden-xs">
                              <!-- <img src="img/author.png" alt="img"> -->
                              <p><a href="upcoming-events" target="_blank" style="color:#FFFFFF">Upcoming Events</a></p>
                          </div>
                      </div>
                  </li>
