        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    <thead>
                    <tr style="background:#1b3e8f; color:#FFFFFF;text-align:center;">
                        <th>Year Level</th>
                        <th>Date of Birth</th>
                    </tr>
                    </thead>
                    ...
                    */?>
                    ...
                    <tr>
                        ...
                        <td>A boy born on or after June 1, 2008 is eligible to apply for C1</td>
                    </tr>
                    <?php /*
                            <tr>
                    ...
                    */?>
                    ...
                    <tr>
                        <td>Year 12 (H1)<br><strong>A Level/FSc (First Year)</strong></td>
                        <td>A boy born on or after June 1, 2006 is eligible to apply for H1</td>
                    </tr>
