                        ...
                        <div class="row">
                          <div class="col-lg-12  col-lg-offset-1 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-1">
                            <div id="gallerySLide" class="sgallery_area">
                                ...
                                for($i=1; $i <= 8; $i++) {
                                ?>
                                    <a href="galimages/careersevening2016-29112016/<?php echo $i;?>.jpg" title="<?php echo $large_imgtitle;?>">
                                      <img class="gallery_img" src="galimages/careersevening2016-29112016/small/<?php echo $i;?>.jpg" alt="img" />
