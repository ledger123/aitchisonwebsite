...
$readOnly = '';
$message = 'Please provide Gmail account and mobile number.';
/*
...
<?php $title = "Student's Profile"; include($path."includes.php"); ?>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <?php } ?>
                                    <form id="form2" method="post" action="user-contacts.php" class="form-horizontal form-label-left">
