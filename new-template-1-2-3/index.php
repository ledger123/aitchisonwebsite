...
include_once ($path ."resources/php/Mobile_Detect.php");
...
<div class="toaster ibsc">
    <a href="news-1942-the-international-boys-schools-coalition" target="_blank">
        <img src="<?php echo $path;?>resources/assets/images/logos/ibsc-member-2.jpeg"/>
    </a>
</div>
...
<div class="container-fluid" style="margin-top: -60px;">
    ...
    <div class="row" id="sect-announcements">
            ...
            <div id="announcements" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    ...
                    <a href="sports/cricket-live-scoreboard" target="_blank">
                        <div class="img-item">
                            <img src="<?php echo $path;?>resources/assets/images/announcements/score-board.jpg">
                        </div>
                ...
                <div class="item">
                    ...
                    <a href="news-1564-admissions-to-aitchison-college-2023-24" target="_blank">
                        <div class="img-item">
                            <img src="<?php echo $path;?>resources/assets/images/announcements/admissions.jpg">
                        </div>
                ...
                <div class="item">
                    ...
                    <a href="news-482-reliving-aitchison-how-to-place-an-order" target="_blank">
                        <div class="img-item">
                            <img src="<?php echo $path;?>resources/assets/images/announcements/reliving-aitchison.jpg">
                ...
                <div class="item">
                    ...
                    <a href="school-song" target="_blank">
                        <div class="img-item" style='background-image: url("resources/assets/images/announcements/school-song.jpg");'>
                            <img src="<?php echo $path;?>resources/assets/images/announcements/school-song.jpg">
		...
		<div class="col-12 text-center">
            <div class="divider"></div>
			<span class="owl-prev announcements-previous-button back-arrow"><img src="<?php echo $path;?>resources/assets/images/arrow-left.png" alt="back-arrow"/></span>
            <span class="owl-next announcements-next-button next-arrow"><img src="<?php echo $path;?>resources/assets/images/arrow.png" alt="next-arrow"/></span>
		</div>
    ...
    <div class="row">
        <div id="featured-news" class="news-highlights">
            ...
            <div class="news-carousel owl-carousel owl-theme">
                    ...
                    <div class="news-box">
                        <a href="activity-glimpses" target="_blank">
                            <div class="news-image">
                                <img src="<?php echo $path;?>newsletter/news/images/12-2040348143.jpg" alt="News" class="img-fluid"/>
                            </div>
                ...
                <div class="item">
                    <div class="news-box">
                        <a href="news-2124-hassan-jamal-secured-2nd-position-for-pakistan-in-tent-pegging" target="_blank">
                            <div class="news-image">
                                <img src="https://aitchison.edu.pk/newsletter/news/images/tent-pegging-2124-1-9456350909.jpg" alt="News" class="img-fluid"/>
                            </div>
                            <div class="news-contents" style="padding: 1rem;">
                                ...
                                <h3 class="news-heading">
                                    Hassan Jamal secured 2nd position for Pakistan in Tent pegging
                                </h3>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-5 col-md-5 col-sm-12 col-xs-12 home-left-container">
                    <div class="row home-left">
                        ...
                        <div>
                            <img src="<?php echo $path;?>resources/assets/images/home/hourse.png" class="img-fluid"/>
    ...
    <div id="sect-boarding" class="row">
        ...
        <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12 col-xs-12 p-0">
            <div id="boarding-houses" class="owl-carousel owl-theme">
                <div class="card">
                    <img class="card-img-top img-fluid" src="<?php echo $path;?>resources/assets/images/boarding/1.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/2.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/3.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/4.jpg"/>
                </div>
                <?php /*?><div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/5.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/6.jpg"/>
                </div><?php */?>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/7.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/8-new.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/9.jpg"/>
                </div>
                <?php /*<div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/10.jpg"/>
                </div> */?>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/12.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/13.jpg"/>
                </div>
                <div class="card">
                    <img class="card-img-top" src="<?php echo $path;?>resources/assets/images/boarding/14.jpg"/>
                </div>
        ...
        <div class="row pe-0">
            ...
            <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12 col-xs-12 text-md-end pe-0 arrows">
                <span class="owl-prev boarding-previous-button back-arrow"><img src="<?php echo $path;?>resources/assets/images/arrow-left.png" alt="back-arrow"/></span>
                <span class="owl-next boarding-next-button next-arrow"><img src="<?php echo $path;?>resources/assets/images/arrow.png" alt="next-arrow"/></span>
            </div>
        </div>
            ...
            <div class="container">
                <div id="sports" class="owl-carousel owl-theme h-100">
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/athletic.jpg" />
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/cricket.jpg" />
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/hockey.jpg" />
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/swimming.jpg" />
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/riding.jpg" />
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/rugby.jpg" />
                        <a href="sports/rugby">
                            <div>
                                <h5>Rugby</h5>
                            </div>
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/shooting.jpg" />
                    ...
                    <div class="sport-item">
                        <img src="<?php echo $path;?>resources/assets/images/sports/tennis.jpg" />
    ...
    <div id="sect-associations" class="row">
        ...
        <div id="logos" class="logos pb-4 pt-2 owl-carousel owl-theme">
            ...
            <div class="cambridge">
                <img src="<?php echo $path;?>resources/assets/images/logos/cambridge.png"/>
            </div>
            <div class="g20">
                <img src="<?php echo $path;?>resources/assets/images/logos/g30.png"/>
            </div>
            <div class="ibsc-member">
                <img src="<?php echo $path;?>resources/assets/images/logos/ibsc-member.png"/>
            </div>
            <div class="spears-schools">
                <img src="<?php echo $path;?>resources/assets/images/logos/spears-schools-index.png"/>
            </div>
            <div class="cambridge-international">
                <img src="<?php echo $path;?>resources/assets/images/logos/cambridge-international.png"/>
            </div>
            <div class="cambridge-igcse">
                <img src="<?php echo $path;?>resources/assets/images/logos/cambridge-igcse.png"/>
            </div>
            <?php /* <div class="aga-khan2">
                <img src="resources/assets/images/logos/aga-khan-2.png"/>
            </div>*/?>
            <div class="fedral-board">
                <img src="<?php echo $path;?>resources/assets/images/logos/fedralboard.png"/>
            </div>
        </div>
    </div>
