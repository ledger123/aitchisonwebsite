            ...
            <div class="ourCourse_content">
              <ul class="course_nav">
                ...
                <li>
                  <div class="single_course">
                    <div class="singCourse_imgarea">
                      <img src="img/alumni-news/upcoming-alumni-events-20200831.jpg" alt="logo" />
                      <div class="mask">                         
                        <a href="events.php" class="course_more">UPCOMING ALUMNI EVENTS</a>
                      </div>
                    </div>
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="events.php">UPCOMING ALUMNI EVENTS</a></h3>
                    <p>Look out for upcoming events </p>
                    </div>
                    <div class="singCourse_author">
                      <img src="img/author.png" alt="img">
                      <p><a href="events.php" style="color:#FFFFFF">Read more...</a></p>
                    </div>
                  </div>
                </li>
