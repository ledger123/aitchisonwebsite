      ...
      <div class="container">
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
			...
			?>
            <h2 class="titile colorblue tleft "><strong>Computer Use Policy </strong></h2>
            <?php /*?>hrplace
            <hr class="style-eight"><?php */?>
              <br>
             <p><a href="download-scup-policy.php?download=yes"><span style="font-weight: bold; color: #07095B;"> Download Computer Use Policy </span> </a></p>
          </div>
          <!-- End course content -->
