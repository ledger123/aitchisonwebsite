            ...
            <div class="row">
                ...
                <div class="col-lg-12  col-lg-offset-1 col-md-12 col-md-offset-1 col-sm-12 col-sm-offset-1">
                    <div id="gallerySLide" class="gallery_area">
						<?php
                        $titles_large=array("Imran Khan", "Iftikhar Ali Khan Pataudi", "Majid Khan", "Rameez Raja", "Hassan Sardar", "Qasim Zia", "Rashid A. Malik", "Wahab Riaz", "Syed Muhammad Jaffar in Hockey Team Berlin 1936");
						$titles_small=array("Imran Khan", "Iftikhar Ali Khan Pataudi", "Majid Khan", "Rameez Raja", "Hassan Sardar", "Qasim Zia", "Rashid A. Malik", "Wahab Riaz", "S. M. Jaffar");
                        $galArray = ["imrankhan.jpg", "iftikhar-ali-khan-pataudi.jpg", "mj.jpg", "rameezraja.jpg","hs.jpg", "qasimzia.jpg", "rashid.jpg", "wahabriaz.jpg", "hockey-team-berlin-1936.jpg"];

                        $foldername=$image_path."img/sportsheroes/";
                        $foldernames=$image_path."img/sportsheroes/small3/";
                        for($i=0 ; $i <=count($galArray); $i++){
                            if(!file_exists($foldernames.$galArray[$i])){
                                continue;
                            }
                            ?>
                            <a href="<?php echo $foldername.$galArray[$i];?>" title="<?php echo ($titles_large[$i]);?>">
                                <img class="gallery_img" src="<?php echo $foldernames.$galArray[$i];?>" alt="<?php echo $titles[$i];?>" />
                                <span class="view_btn"><?php echo $titles_small[$i];?> New</span>
                            </a>
                            <?php
                        }
					
                        ?>
                        <?php /*?><a href="<?php echo $image_path;?>img/sportsheroes/imrankhan.jpg" title="Imran Khan">
