...
<ul id="css3menu1" class="topmenu">
    ...
    <li class="topmenu" style="width: 100%; height: 100%;"><a href="#" style="height:32px;padding-top: 10px;"><span style="font-size: 36px;" id="jump"></span><img src="resources/assets/images/logos/horse-logo.svg"/></a>
        <ul id="jumpto">
            ...
            <li><a href="#sect-aitchison-college">Important</a></li>
            <li><a href="#sect-boarding">Boarding</a></li>
            <li><a href="#sect-sports">Sports</a></li>
            <li><a href="#sect-associations">Associations</a></li>
            <li><a href="https://aitchison.edu.pk/portal/acportal">Parents Portal</a></li>
        </ul>
    </li>
</ul>
            ...
            <div id="announcements" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    ...
                    <a href="news-1423-136th-founders-day-2022" target="_blank">
                        ...
                        <div class="img-item" style='background-image: url("resources/assets/images/announcements/old-boy-bulletin.jpg");'>
                ...
                <div class="item">
                    ...
                    <a href="photo-of-the-week" target="_blank">
                        <div class="img-item" style='background-image: url("resources/assets/images/announcements/photo-of-week-20220415.jpg");'>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 p-xl-5 p-lg-3 p-md-2">
                    <div class="news-box box-shadow-4">
                        <a href="news-1449-remembrance-of-raza-kuli-khan-khattak" target="_blank">
                            <div class="news-image">
                                <img src="https://aitchison.edu.pk/newsletter/news/images/wale-image-8207334967.jpg" alt="News" class="img-fluid"/>
                            </div>
                            <div class="news-contents" style="padding: 1rem;">
                                ...
                                <h3 class="news-heading header">
                                    Remembrance of Raza Kuli Khan Khattak
                                </h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 p-xl-5 p-lg-3 p-md-2">
                    <div class="news-box box-shadow-4" style="border-right: 5px #8E1537FF solid;">
                        <a href="news-1439-aitchison-boys-bag-ivy-leagues-and-oxbridge-2022-update" target="_blank">
                            <div class="news-image">
                            ...
                            <div class="news-contents" style="padding: 1rem;">
                                ...
                                <h3 class="news-heading header">
                                    AITCHISON BOYS BAG IVY LEAGUES AND OXBRIDGE 2022 UPDATE
                                </h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 p-xl-5 p-lg-3 p-md-2">
                    <div class="news-box box-shadow-4" style="border-right: 5px #8E1537FF solid;">
                        <a href="news-1438-ground-breaking-ceremony-for-monnoo-boarding-house" target="_blank">
                            <div class="news-image">
                                <img src="https://aitchison.edu.pk/newsletter/news/images/8-2094485381.jpg" alt="News" class="img-fluid"/>
                            </div>
                            <div class="news-contents" style="padding: 1rem;">
                                <div class="news-date" style="color: #4d4d4d; margin: 5px 0;">
                                    31 March, 2022
                                ...
                                <h3 class="news-heading header">
                                    Ground Breaking Ceremony for Monnoo Boarding House
                                </h3>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7 col-md-7 col-sm-12 col-xs-12 p-5 text-center" style="background-color: rgb(1 131 53 / 40%); height: 100%;">
                ...
                <div class="row home-items">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12"><a href="portal/acportal">Portals</a></div>
                </div>
            </div>
