...
$page_header = "Ten Basic Questions";

$faqs = [];

$faqs[] = ['q' => "Why Be a Boarder at Aitchison College?",
    'a' => "Aitchison is Pakistan’s most recognized and best equipped boarding school. Set in 200 beautiful acres, boarding is a key component of our educational program –not an optional extra –and receives strong support from a caring and highly qualified residential teaching staff. Living with over 400 other ambitious boys admitted from all parts of Pakistan, as well as select boys from overseas, boarding life is an enriching experience underpinning one of the finest old boy networks in the world.  This network is a major advantage in career support."];
...
$faqs[] = ['q' => "What Can I Study at Aitchison?",
    'a' => "Both International and National curricula are available. Aitchison has been a Cambridge Examination Centre since 1935, and offers IGCSE and A Level courses. In addition, we also offer Aga Khan Matric, FA and FSc syllabuses. Boys have the best range of choices in Pakistan."];
...
$faqs[] = ['q' => "Do Boarders Play Sports?",
    'a' => "Yes, but boarders love sports and also engage in as many as 22 different clubs and societies. It’s hard not to enjoy sport with so many international standard facilities that Aitchison offers. Boarders invariably make up our strongest sporting teams."];
...
<style>
    ...
    .accordion-button {
        ...
        background-color: #fcfcff; /*#f3e6c1;*/
