...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Aitchison College:- Principal's Past Newsletters</title>
      ...
      <div class="container">
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <h2 class="titlewithoutborder colorblue hrplace border-blue" style="position: relative; display: inline-block;">Principal's Past Newsletters</h2>
            <br><br>
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 media" style="vertical-align:top;">
                    <a href="<? echo $href; ?>" target="<? echo $target; ?>" style="text-decoration:none;">
                    	<table>
                        <tr>
							<td valign="top" style="padding-right: 10px;"><div style="padding: 5px; border: 3px #369 solid; border-radius: 10px;"><span class="glyphicon glyphicon-envelope" style="font-size: 32px; color: #369;"></span></div></td>
                            <td><div style="display: inline;font-size:18px;"><?php echo htmlentities(stripslashes(utf8_decode($row->Heading)));?><br />
                            <span style="font-size:16px;color:#818181;"><?php echo $date;?></span></div></td>
                        </tr>
                        </table>
                    </a>
