...
$page_glimse_name="activityglimpses/".intval($_GET['yearNumber'])."/".$_GET['monthName']."-week"."-".$_GET['weekNumber'].".php";
...
<div class="container-fluid">
    ...
    <div class="col-lg-9 col-md-12 col-sm-12">
        <div class="col-12 page-title">
			...
			<p style="font-size:1.5rem;color:#800000;"><?php echo $second_title;?></p>
        </div>
...
<div class="container">
    ...
    <?php
		if(file_exists($page_glimse_name)){
			...
			//$pexists="<br>".$page_glimse_name." Is Exists";
		}
	?>
    <!-- End Contents -->
