...
<?php $title = "Welcome to Boarders’ Portal"; include($path."includes.php"); ?>
<style>
#defaultIcon {
  position: relative;
}
					...
					<div class="x_panel">
					  <div class="x_content">
						  ...
						  <div class="row">
							...
							<div>
								<p>Welcome to our new Boarders’ Portal: instant, online, timely and secure information, the Portal will assist you with many things, including attendance, syllabus, examinations, classes, and sports. There are many categories of information designed to help you.</p>
