            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered" style="width: 97%;" id="term-dates">
                    ...
                    <tbody>						
                        <tr>
                            <td>Winter Term</td>
                            <td>Monday, 22<sup>nd</sup> August, 2022 to Thursday, 22<sup>nd</sup> December 2022 (18 Weeks, 89 Days)</td>
                        </tr>
                        <tr>
                          <td>Mid Term Break</td>
                          <td>Sunday, 16<sup>th</sup> October - Tuesday, 18<sup>th</sup> October,2022</td>
                        </tr>
                        <tr>
                          <td>Winter Break</td>
                          <td>Friday,23<sup>rd</sup> December, 2022 to Sunday, 8<sup>th</sup> January, 2023</td>
                        </tr>
                        <tr>
                          <td>Spring Term</td>
                          <td>Monday, 9<sup>th</sup> January 2023 to Sunday, 12<sup>th</sup> March, 2023             (9 Weeks, 47 Days)</td>
                        </tr>
                        <tr>
                          <td>Spring Break</td>
                          <td>Monday, 13<sup>th</sup> March, 2023 to Sunday, 19<sup>th</sup> March, 2023</td>
                        </tr>
                        <tr>
                          <td>Summer Term</td>
                          <td>Monday, 20<sup>th</sup> March 2023 to Friday, 2<sup>nd</sup> June 2023                   (11 Weeks, 55 Days)</td>
                        </tr>
                        <tr>
                          <td>Summer Holidays</td>
                          <td>Saturday, 3<sup>rd</sup> June 2023 to onwards</td>
                        </tr>
					</tbody>
                </table><br>
				<table class="table table-bordered" style="width: 97%;"  id="boarder-return-dates">
                    ...
                    <tbody>						
                        <tr>
                          ...
                          <td>Saturday, 20<sup>th</sup> August, 2022</td>
                        </tr>
						<tr>
						  <td>Junior, Prep and Senior Schools’ Boarders to Report from 5:00 pm (Spring Term)</td>
						  <td>Sunday, 8<sup>th</sup> January, 2023</td>
					  </tr>
						<tr>
						  <td>Junior, Prep and Senior Schools’ Boarders to Report from5:00 pm (Summer Term)</td>
						  <td>Sunday, 19<sup>th</sup> March, 2023</td>
					  </tr>
					</tbody>
                </table><br>
				<table class="table table-bordered" style="width: 97%;" id="tpm-dates">
                    ...
                    <tbody>						
                        <tr>
						  ...
						  <td>Friday, 14<sup>th</sup> October - Saturday, 15<sup>th</sup> October, 2022</td>
					  </tr>
						<tr>
						  <td>2<sup>nd</sup> Teacher Parent Meeting</td>
						  <td>Friday, 17<sup>th</sup> February - Saturday, 18<sup>th</sup> February, 2023</td>
					  </tr>
						<tr>
						  <td>3<sup>rd</sup> Teacher Parent Meeting</td>
						  <td>Friday, 5<sup>th</sup> May - Saturday, 6<sup>th</sup> May, 2023</td>
					  </tr>
					</tbody>
                </table><br>
				...
				<table class="table table-bordered" style="width: 97%;" id="founders-day-dates">
                    ...
                    <tbody>						
                        <tr>
						  <td>Founders’ Day Sports – 2023 (Day 1)</td>
						  <td>Friday, 10<sup>th</sup> March, 2023</td>
					  </tr>
						<tr>
						  <td>Founders’ Day Academics – 2023 (Amphitheatre)</td>
						  <td>Saturday, 11<sup>th</sup> March 2023</td>
					  </tr>
						<tr>
						  <td>Founders’ Day Sports – 2023 (Day 2)</td>
						  <td>Sunday, 12<sup>th</sup> March, 2023</td>
					  </tr>
                    </tbody>
                </table>
