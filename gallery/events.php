    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div id="gallerySLide" class="sgallery_area4">
                ...
                <a href="gallerydetails-64-sports-day-2023" title="Sports Day 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/64/small/12.jpg" alt="img">
                    <span class="view_btn">Sports Day 2023</span>
                </a>
				
				<a href="gallerydetails-62-jafar-memorial-hockey-championship-2023" title="Jafar Memorial Hockey Championship 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/62/small/10.jpg" alt="img">
                    <span class="view_btn">Jafar Memorial Hockey Championship 2023</span>
                </a>
				
				<a href="gallerydetails-63-aitchison-mun-2023" title="Aitchison MUN 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/63/small/3.jpg" alt="img">
                    <span class="view_btn">Aitchison MUN 2023</span>
                </a>
				
				<a href="gallerydetails-61-prep-school-science-exhibition-2023" title="Prep School Science Exhibition 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/61/small/2.jpg" alt="img">
                    <span class="view_btn">Prep School Science Exhibition 2023</span>
                </a>
				
				<a href="gallerydetails-60-vahali-challenge-cup-2023" title="Vahali Challenge Cup 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/60/small/14.jpg" alt="img">
                    <span class="view_btn">Vahali Challenge Cup 2023</span>
                </a>
				
				<a href="gallerydetails-59-general-assembly-2023" title="General Assembly 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/59/small/34.jpg" alt="img">
                    <span class="view_btn">General Assembly 2023</span>
                </a>
				
				<a href="gallerydetails-58-aitchison-business-concept-2023" title="Aitchison Business Concept 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/58/small/3.jpg" alt="img">
                    <span class="view_btn">Aitchison Business Concept 2023</span>
                </a>
				
				<a href="gallerydetails-57-hali-challenge-cup-2023" title="Hali Challenge Cup 2023">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/57/small/4.jpg" alt="img">
                    <span class="view_btn">Hali Challenge Cup 2023</span>
                </a>
				
				
				
				<a href="gallerydetails-56-founders-day-2022" title="Founders' Day">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/56/7.jpg" alt="img">
                    <span class="view_btn">Founders' Day</span>
                </a>
				
				
				<a href="gallerydetails-55-prep-school-english-play-2022" title="Prep School English Play 2022
">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/55/16.jpg" alt="img">
                    <span class="view_btn">Prep School English Play 2022</span>
                </a>
				
				
				<a href="gallerydetails-54-acmun-2022" title="ACMUN 2022">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/54/5.jpg" alt="img">
                    <span class="view_btn">ACMUN 2022</span>
                </a>
				
				
				<a href="gallerydetails-53-aclac-2022-german-french-language-festival" title="ACLAC 2022 - German French Language Festival">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/53/3.jpg" alt="img">
                    <span class="view_btn">ACLAC 2022</span>
                </a>
				
				<a href="gallerydetails-52-ps-science-exhibition" title="PS Science Exhibition">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/52/22.jpg" alt="img">
                    <span class="view_btn">PS Science Exhibition</span>
                </a>
				
				<a href="gallerydetails-51-arena-polo" title="Arena Polo">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/51/2.jpg" alt="img">
                    <span class="view_btn">Arena Polo</span>
                </a>
				
				<a href="gallerydetails-50-founders-day-academics-2022" title="Founders Day Academics">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/50/1.jpg" alt="img">
                    <span class="view_btn">Founders' Day Academics</span>
                </a>
				
				<a href="gallerydetails-49-art-exhibition" title="Art Exhibition">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/49/25.jpg" alt="img">
                    <span class="view_btn">Art Exhibition</span>
                </a>
				<a href="gallerydetails-48-inter-house-cross-country-race-2022" title="Inter-House Cross Country Race 2022">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/48/15.jpg" alt="img">
                    <span class="view_btn">Inter-House Cross Country Race 2022
</span>
                </a>
				<a href="gallerydetails-47-senior-school-drama-2022" title="Senior School Drama 2022">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/47/15.jpg" alt="img">
                    <span class="view_btn">Senior School Drama 2022</span>
                </a>
                <a href="gallerydetails-46-cross-country-race-junior-school-2022" title="CROSS COUNTRY JS 2022">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/46/18.jpg" alt="img">
                    <span class="view_btn">CROSS COUNTRY JS 2022</span>
                </a>
                <a href="gallerydetails-45-sports-day-2022" title="SPORTS DAY 2022">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/45/6.jpg" alt="img">
                    <span class="view_btn">SPORTS DAY 2022</span>
                </a>
                ...
                <a href="gallerydetails-30-founders-day-sports-2019" title="Founders' Day Sports">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/30.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports</span>
                </a>
                <a href="gallerydetails-29-founders-day-academics-2019" title="Founders' Day Academics">
                ...
                <a href="../news-460-js-inter-house-cross-country-2019" title="JS INTER- HOUSE CROSS COUNTRY 2019">
                ...
                <a href="gallerydetails-26-founders-day-sports-2018" title="Founders' Day Sports">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/26.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports</span>
                </a>
                <a href="gallerydetails-25-founders-day-sports-senior-school-2018" title="Founders' Day Sports (Senior School)">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/25.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports (Senior School)</span>
                </a>
                <a href="gallerydetails-24-founders-day-sports-prep-school-2018" title="Founders' Day Sports (Prep School)">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/24.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports (Prep School)</span>
                </a>
                <a href="gallerydetails-23-founders-day-sports-junior-school-2018" title="Founders' Day Sports (Junior School)">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/23.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports (Junior School)</span>
                </a>
                ...
                <a href="gallerydetails-19-founders-day-sports-senior-school-2017" title="Founders' Day Sports (Senior School)">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/19.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports (Senior School)</span>
                </a>
                <a href="gallerydetails-18-founders-day-sports-prep-school-2017" title="Founders' Day Sports (Prep School)">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/18.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports (Prep School)</span>
                </a>
                <a href="gallerydetails-17-founders-day-sports-junior-school-2017" title="Founders' Day Sports (Junior School)">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/17.JPG" alt="img">
                    <span class="view_btn">Founders' Day Sports (Junior School)</span>
                </a>
                <a href="gallerydetails-16-131supspan-styletext-transform-lowercase-vertical-align-superstspansup-founders-day-academics-2017" title="131st FOUNDERS' DAY ACADEMICS ">
                    <img class="gallery_img" src="<?php echo $image_path;?>galimages/images/16.JPG" alt="img">
                    <span class="view_btn">131<sup><span style="text-transform: lowercase; vertical-align: super;">st</span></sup> FOUNDERS' DAY ACADEMICS </span>
                </a>
