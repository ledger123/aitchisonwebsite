...
$gal_array["general"]["title"]=array(
	...
	"57"	=>	"Hali Challenge Cup 2023",
	"58"	=>	"Aitchison Business Concept 2023",
	"59"	=>	"General Assembly 2023",
	"60"	=>	"Vahali Challenge Cup 2023",
	"61"	=>	"Prep School Science Exhibition 2023",
	"62"	=>	"Jafar Memorial Hockey Championship 2023",
	"63"	=>	"Aitchison MUN 2023",
	"64"	=>	"Sports Day 2023"
);
...
$gal_array["events"]["title"]=array(
    ...
    "14"	=> "ACMUN",
    "15"	=>  "CROSS COUNTRY RACES 2017",
    "16"	=>  "131<sup><span style=\"text-transform: lowercase; vertical-align: super;\">st</span></sup> FOUNDERS' DAY ACADEMICS",
    "17"	=>  "Founders' Day Sports (Junior School)",
    "18"	=>  "Founders' Day Sports (Prep School)",
    "19"	=>  "Founders' Day Sports (Senior School)",
    "20"	=>  "Walter A . Robinson Challenge Cup 2018",
    "21"	=>  "GENERAL ASSEMBLY",
    "23"	=>  "Founders' Day Sports (Junior School)",
    "24"	=>  "Founders' Day Sports (Prep School)",
    "25"	=>  "Founders' Day Sports (Senior School)",
    "26"	=>  "Founders' Day Sports",
    "28"	=>  "Sports Day",
    "29"	=>  "Founders' Day Academics",
    "30"	=>  "Founders' Day Sports",
    "31"    =>  "Annual Urdu Play (Senior School)",
    "32"    =>  "English Play (Prep School)",
    "33"    =>  "English Play (Senior School)",
    "34"    =>  "LJ House Dinner",
            ...
            <div id="gallerySLide" class="sgallery_area4">
                ...
                for($i=1; $i <= intval($gal_array["general"]["count"][$gal_id]); $i++){
                    ...
                    if(!file_exists($cfile)) {
                        ...
                        ?>
                        <a href="<?php echo $foldername.$filename;?>" title="<?php echo strip_tags($gal_array["events"]["title"][$gal_id]);?>">
