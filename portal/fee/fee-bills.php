								  ...
								  <ul id="tabs" class="nav nav-tabs bar_tabs" role="tablist">
									...
									<?php 
									  ...
									  if(!(in_array(trim($_SESSION['portal_SchoolNo']), $feeRepo->GetBlockedNos()) || ( !isset($dRow) || strlen($dRow->FeeBillNo) < 2))) {
										  if(time() <= (strtotime($dRow->DueDate)+24*3600) || true){											  
									?>  
									...
									<?php
										  $feeChallanLink="fee-challan.php?bill_id=".$purifier->purify($dRow->FeeBillNo);
										  }else{
											  $feeChallanLink="#printchallan";										 
									?>									  
									  <li role="presentation" class="">
										  <a href="#printchallan" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">
											  <i class="fa fa-print"></i> Challan Form
										  </a>
								  ...
								  <div id="myTabContent" class="tab-content">
									  ...
									  <div class="tab-pane fade in" id="printchallan">
										  ...
										  <div class="row">											
												<div class="">
												<div class="col-lg-12 col-md-12 col-sm-12">
													<span style="color: #990000; font-weight: bold; text-transform: uppercase; font-style: italic;  padding-top: 8px;"> <br>Challan Forms are not available after the due date. Kindly contact with Accounts department.</span>
												</div>
											</div>
