      ...
      <div class="container">
        <div class="row" style="min-height: 300px;">
          ...
          <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <h2 class="titlewithoutborder colorblue hrplace border-blue" style="display: inline-block;">The Old Building Fund</h2>
            <p>&nbsp;</p>
            <h2 class="titlewithoutborder colorblue hrplace border-blue" style="display: inline-block; font-size: 20px;">List of Donors</h2>
            <p>&nbsp;</p>
            <div class="row">
            	<div class="col-lg-9 col-md-8 col-sm-12">
                	<p>We would like to thank the following donors for their contributions to the Old Building Endowment Fund.</p>
                    <ul style="line-height: 1.7em; text-align: justify; padding-left: 30px !important;list-style-type: disc;">
                        ...
                        <li>Mr. Hamid Hussain</li>
                        <li>Mr. Ahmed Shahid Hussain</li>
                        <li>Syed Mohammad Mohsin</li>
                        <li>Mr. Bilal Rashid</li>
                        <li>Mr. Atif Aslam Bajwa</li>
                        <li>Mr. Yawar Shah</li>
                        <li>Mr. Humayun Mazhar</li>
                        <li>Mr. Zulfiqar Monnoo</li>
                        <li>Mr. Tariq Sayeed Saigol</li>
                        <li>Mr. Salman Akhtar</li>
