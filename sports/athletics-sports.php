...
$banner_url = $path.'resources/assets/images/banners/athletics.jpg';
?>
        ...
        <div class="col-lg-9 col-md-12 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <img src="<?php echo $image_path;?>img/athletics/4.jpg" alt="" class="img-fluid" style="margin: 10px auto; display: block;">
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <img src="<?php echo $image_path;?>img/athletics/5.jpg" alt="" class="img-fluid" style="margin: 10px auto; display: block;">
