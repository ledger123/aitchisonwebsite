<?php
	...
	$title="Aitchison : Bespeaks heritage";
?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <title>Aitchison : Reminiscence</title>
    <!-- Favicon -->
  ...
  <section id="error">
    <div class="container">
      <div class="row">
        ...
        <img src="assets/images/EMB_2068.jpg" alt="Pic" width="70%" height="40%">
              <p>The Old tree is a majestic spectacle that bespeaks heritage, strength and stability.<br> 
What memories does this picture evoke for you?
</p>
