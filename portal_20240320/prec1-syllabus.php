...
if ($_SESSION['portal_CurrentClass'] == "M2"){
	$howework_link = "accounts/syllabus-files/pre-c1-21032020.zip";
}else{
	header("syllabus.php");
	exit();
}

$howework_link = Filing::GetURL("", "Pre C1 Syllabus", "../".$howework_link);
...
<?php $title = "Pre C1 Syllabus"; include($path."includes.php"); ?>
<!-- FullCalendar -->
					...
					<div class="x_panel">
					  <div class="x_content">
						  <div class="row">
							  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								  <div class="page-title">
									  <h4 style="margin-top:0;">Pre C1 Syllabus</h4>
								  </div>
							  </div>
						  ...
						  <div class="row" align="right" style="margin: 15px 0;">
							  <p>
								  <a href="<?php echo $howework_link; ?>" target="_blank" class="active lnkDownload"><span style=""><span class="glyphicon"></span> Download Pre C1 Syllabus </span> </a>
							  </p>
						  </div>
						  <div class="row">
