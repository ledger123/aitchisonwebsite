...
<?php $title = "Events"; include($path."includes.php"); ?>
            ...
            <div class="container">
				<div class="row" id="newsletter">
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                      <div><a href="allevents.php" class="btn btn-primary" style="width: 100%;">Term Dates</a></div>
                      <div><a href="allevents.php" class="btn btn-primary" style="width: 100%;">Leaves for Boarders</a></div>
                      <div><a href="allevents.php" class="btn btn-primary" style="width: 100%;">Designated Holiday Periods</a></div>
                      <div><a href="allevents.php" class="btn btn-primary" style="width: 100%;">Major Assessments</a></div>
				  </div>
				</div>
            </div>
