        ...
        <div class="slide-content">
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="slide-article">
                  <h1 class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">Let's Reconnect from all over the world</h1>
              ...
              <ul class="course_nav">
                <li>
                  <div class="single_course">
                    <div class="singCourse_imgarea">
                      ...
                      <div class="mask">                         
                        <a href="../make-a-gift" class="course_more">Support the College</a>
                      </div>
                    </div>
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="../make-a-gift">Support the College</a></h3>
                   <!--	 <p class="singCourse_price"><span>$20</span> Per One Month</p> -->
                    <p class="hidden-xs" style="color: #fff;">Appeal for support from Old Boys<!-- win in years.--></p>
                    </div>
                    <div class="singCourse_author hidden-xs">
                      <img src="img/author.png" alt="img">
                      <p><a href="../make-a-gift"  style="color:#FFFFFF">Read more...</a></p>
                    </div>
                  </div>
                </li>
                  ...
                  <li>
                      <div class="single_course">
                          <div class="singCourse_imgarea">
                              <img src="https://aitchison.edu.pk/newsletter/news/images/14-9774788230.jpg" alt="Pre 1970 Leavers Lunch at Principal House" />
                              <div class="mask">
                                  <a href="../news-1865-pre-1970-leavers-lunch-at-principal-house" class="course_more" target="_blank"> Pre 1970 Leavers Lunch at Principal House </a>
                              </div>
                          </div>
                          <div class="singCourse_content">
                              <h3 class="singCourse_title"><a href="../news-1865-pre-1970-leavers-lunch-at-principal-house" target="_blank">Pre 1970 Leavers Lunch at Principal House
</a></h3>
                              <p class="hidden-xs"></p>
                          </div>
                          <div class="singCourse_author hidden-xs">
                              <img src="img/author.png" alt="img">
                              <p><a href="../news-1865-pre-1970-leavers-lunch-at-principal-house" target="_blank" style="color:#FFFFFF">Read more...</a></p>
                          </div>
                      </div>
                  </li>
                ...
                <li>
                  <div class="single_course">
                    <div class="singCourse_imgarea">
                      ...
                      <div class="mask">                         
                        <a href="news-132-alumnus-in-focus" class="course_more">ALUMNUS IN FOCUS</a>
                      </div>
                    </div>
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="news-132-alumnus-in-focus">Alumnus in Focus</a></h3>
                    <p class="hidden-xs">An interview with Sameer Khosa</p>
                    </div>
                    <div class="singCourse_author hidden-xs">
                      <img src="img/author.png" alt="img">
                      <p><a href="news-132-alumnus-in-focus" style="color:#FFFFFF">Read more...</a></p>
                    </div>
                  </div>
                </li>
                -->
                ...
                <li>
                  <div class="single_course">
                    ...
                    <p class="hidden-xs" style="color: #fff;">Alumni e-newsletter subscription</p>
                    </div>
                    <div class="singCourse_author hidden-xs">
                      <img src="img/author.png" alt="img">
