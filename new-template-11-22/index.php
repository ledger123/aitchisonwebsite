...
<div class="toaster">
    <a href="news-1564-admissions-to-aitchison-college-2023-24" target="_blank"><h5>Boarding and Day<br>Applications 2023-24</h5></a>
</div>
...
<div class="slogan">
    A school not so much about what a boy should be, as what he might be.
</div>
            ...
            <div id="announcements" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    ...
                    <a href="photo-of-the-week" target="_blank">
                        ...
                        <div class="img-item">
                            <img src="resources/assets/images/announcements/photo-20221003.jpg">
                        </div>
    ...
    <div class="row">
        <div id="featured-news" class="news-highlights">
            ...
            <div class="news-carousel owl-carousel owl-theme">
                    ...
                    <div class="news-box">
                        <a href="activity-glimpses" target="_blank">
                            <div class="news-image">
                                <img src="https://aitchison.edu.pk/newsletter/news/images/6-9451673485.jpg" alt="News" class="img-fluid"/>
                            </div>
                            <div class="news-contents" style="padding: 1rem;">
                                <div class="news-date" style="margin: 5px 0;">
                                    1<sup>st</sup> to 5<sup>th</sup> November, 2022
                                </div>
                ...
                <div class="item">
                    <div class="news-box">
                        <a href="sports/aitchison-vs-lawrence-college-sports-2022" target="_blank">
                            <div class="news-image">
                                <img src="https://aitchison.edu.pk/newsletter/news/images/3-2773789940.jpg" alt="News" class="img-fluid"/>
                            </div>
                            <div class="news-contents" style="padding: 1rem;">
                                <div class="news-date" style="margin: 5px 0;">
                                    13<sup>th</sup> to 16<sup>th</sup> October, 2022
                                </div>
                                <h3 class="news-heading header">
                                    Aitchison College vs Lawrence College
                                </h3>
                ...
                <div class="item">
                    <div class="news-box">
                        <a href="news-1525-aitchison-opens-its-first-new-senior-boarding-house-since-1890" target="_blank">
                            <div class="news-image">
                                <img src="https://aitchison.edu.pk/newsletter/news/images/1-2570833841.jpg" alt="News" class="img-fluid"/>
                            </div>
                            <div class="news-contents" style="padding: 1rem;">
                                <div class="news-date" style="margin: 5px 0;">
                                    20 August, 2022
                                ...
                                <h3 class="news-heading header">
                                    Aitchison opens its first new Senior boarding house since 1890
                                </h3>
