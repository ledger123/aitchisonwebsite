							...
							if( $newsId > 0 )
							{
								...
								<?php
                                    ...
                                    if ( !isset($_GET['title']) ) {
                                        ...
                                        $href = "pletter-new-".$newsId."-".makeSlug($heading);
                              ...
                              <table border="0" style="font-size:28px;">
                                  ...
                                  <tr>
                                      ...
                                      if($navigation["previousId"] >0)
                                          $previous = 'pletter-new-'.$navigation["previousId"]."-".makeSlug($navigation["previousHeading"]);
                                      else $pCssClass = 'disabled';

                                      if($navigation["nextId"] >0)
                                          $next = 'pletter-new-'.$navigation["nextId"]."-".makeSlug($navigation["nextHeading"]);
