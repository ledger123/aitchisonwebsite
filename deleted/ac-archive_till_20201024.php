...
.videos:before {
  ...
  border-radius: 5px;
	...
	#gallery {
		...
		background: rgba(1,1,1,0.5) url("img/archives/background-trans.jpg") no-repeat center;
        ...
        <section id="gallery">
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="MuseumSlide" class="gallery_area">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <img src="img/archives/archives-display-center.jpg" alt="Archives’ Display Centre" class="img-responsive" />
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div id="FaqSlide" class="gallery_area">
                	<h2>FAQ’s</h2>
                	<ul>
                    	<li><strong>How can I donate my collection?</strong></li>
                        <p>We believe that each collection is invaluable and holds great significance. Please schedule a meeting with our College Archivist to review and discuss the process of donating. You can also email at: <span style="color:#000099;">archivist@aitchison.edu.pk</span></p>
                  ...
                  <div id="HelpupSlide" class="gallery_area">
                      ...
                      <p><span style="font-size:16px;line-height:1.8;">Please provide your name, year of <strong>graduation</strong> from Aitchison College, and <strong>the name of the University</strong>. In the case of the University of Oxford and University of Cambridge, please provide the name of your college.</span></p>
                      <p><span style="font-size:16px;line-height:1.8;">Kindly send the information at <span style="color:#0000ff;">alumniofficer@aitchison.edu.pk</span></span></p>
					  <p>OR</p>
					  <p><a href="https://forms.gle/LiYtwgx2QzmbACtE8" target="_blank"><span class="btn btn-primary">Submit Your Information</span></a></p>
