...
<head>
	...
	<?php
		...
		if(strpos($_SERVER['REQUEST_URI'], ".php") || strpos($_SERVER['REQUEST_URI'], "offline")){
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $path;?>resources/vendors/slidermenu/slidermenu.css?v=8">
   ...
   <!--
    ...
    <!-- page style -->
    <link rel="stylesheet" type="text/css" href="<?php echo $path;?>resources/style.css?v=31">

    <link rel="stylesheet" href="<?php echo $path;?>resources/css/jquery.tosrus.all.css">

    <link rel="stylesheet" href="<?php echo $path;?>resources/css/photo-gallery.css?v=22">

    <?php if (true || $fileName !== 'index') {?>
    <!-- page style -->
    <link rel="stylesheet" type="text/css" href="<?php echo $path;?>resources/custom.css?v=29">
    <?php }?>
