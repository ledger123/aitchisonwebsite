		 ...
		 hash_equals( $_SESSION['_tokenm'], $_POST['token'] ) )
	{
		...
		if ( $captcha )
		{
            ...
            elseif( $portal == "SuperPortal" ) {    //management
                ...
                if ( strlen(trim($TxtPassword)) > 4 && strlen(trim($TxtPassword)) < 21 ) {
  ...
  <body class="login2" onLoad="javascript:ready();">
    ...
    <div id="login" align="right">
      <div class="login_wrapper" style="margin: 0 0; margin-top: 6%;">
        <div class="animate form login_form" style="background-color: rgba(0,0,51,0.6);">
          <section class="login_content">
			...
			<form action="acportal" onsubmit="return validate()" method="post">
                ...
                <div style="margin-bottom: 5px;text-align: left;">
                    ...
                    <a style="font-size: 14px;text-shadow: none; text-decoration: none; color: #fff; margin: 0;" href="/" target="_parent">Home</a>

                    <a style="font-size: 14px;text-shadow: none; text-decoration: none; color: #fff; margin: 0; float: right;" href="help" target="new">Help</a>
				...
				<?php if (true) { ?>
					<select id="optPortal" name="optPortal" class="form-control" style="margin: 0 0 20px;" required aria-required="true">
						...
						<option <?php if($sel_portal=="p") echo " selected ";?> value="ParentPortal">My Aitchison</option>
						<?php if (false) { ?>
