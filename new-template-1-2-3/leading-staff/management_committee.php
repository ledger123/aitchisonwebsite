            ...
            <div class="row">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        ...
                        <div><strong>
							Dr. Huma Alia Izhar</strong><br>
							HOD Biology & Head of Sciences<br>
							Senior School</div>
                    </div>
                </div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        ...
                        <div><strong>
							...
							HOD English & Head of the Year H1<br>
							Senior School</div>
                    </div>
                </div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        ...
                        <div><strong>
                            ...
                            HOD Physics & Head of the Year H2<br>
							Senior School</div>
                    </div>
                </div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        ...
                        <div><strong>Dr. Naila Burney Chughtai</strong><br>Guidance Counsellor for UK</div>
                    </div>
                </div>
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        <img src="<?php echo $image_path;?>img/leading-staff/management-committee/mr-jamal-hussain.jpg" alt="" class="img-fluid">
                        <div><strong>Jamal Hussain</strong><br>Guidance Counsellor for Oxford & USA</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="leading-card">
                        <img src="<?php echo $image_path;?>img/leading-staff/holpjs.jpg" class="img-fluid">
                        <div style="min-height: 60px; overflow: hidden;"><strong>Sara Malik</strong><br>Deputy Guidance Counsellor for Oxford & USA</div>
                    </div>
                </div>
            </div>
