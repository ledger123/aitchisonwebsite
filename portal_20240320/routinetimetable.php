...
<?php $title = "School Timings"; include($path."includes.php"); ?>
...
<p>&nbsp;</p><?php */?>
                                ...
                                elseif ( $_SESSION['portal_School'] == "PSD" ) { ?>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												...
												<?php /*?><div  style="text-align: center;" class="page-title">
													<h3>Timetable of classes</h3>
												</div><?php */?>
												<?php
									if($_SESSION['portal_CurrentClass']=="E2" && false){
									?>									
								...
								<?php
									...
									if($_SESSION['portal_CurrentClass']=="M1" && false){
									?>									
									...
									if($_SESSION['portal_CurrentClass']=="M2" && false){
									?>									
