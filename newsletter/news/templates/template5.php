        ...
        <div class="sgallery_area2">
            ...
            ?>
            	<tr>
                	...
                	<td>
                    	<img src="<?php echo $row->FileName1; ?>" alt="img" class="img-responsive" style="max-width:220px; max-height:84px;" />
        ...
        <div class="col-lg-12 col-md-12 col-sm-12" style="padding:0px;">
            <div class="<?php if ( $news->NewsFor == 1 ) echo 'aboutus_area wow fadeInLeft'; else 'blog-news-details blog-single-details'; ?> " style="visibility: visible; animation-name: fadeInLeft;">
                ...
                <?php if ( $news->NewsFor == 1 ) {?>
                    ...
                    <h2 class="titlewithoutborder colorblue hrplace border-blue" style="font-size: 26px; position: relative; display: inline-block;"><?php echo $purifier->purify((stripslashes(utf8_decode($news->Heading)))); ?></h2>
                    <br />
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12" align="center">
                            <div id="gallerySLide" class="sgallery_area2">
                                ...
                                ?>
                                    <a href="<?php echo $purifier->purify($_GET['imagesPath'].$row->FileName2); ?>" title="<?php echo $purifier->purify($row->LargeImageTitle); ?>">
                                        <img class="gallery_img" src="<?php echo $purifier->purify($_GET['imagesPath'].$row->FileName1); ?>" alt="img" />
                                        <span class="view_btn"> <?php echo $purifier->purify($row->SmallImageTitle); ?> </span>
                                    </a>
