...
<html lang="en">
    ...
    <?php $title = "User groups"; include($path."includes.php"); ?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="form1" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="TxtGroupName">Group Name <span class="required">*</span>
                        </label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="OptAdmin">Admin</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <?php $OptAdmin->Bind(); ?>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="OptActive">Active</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <?php $OptActive->Bind(); ?>
                        </div>
                      </div>
