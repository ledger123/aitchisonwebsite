...
if ( isset($_POST['cmdSubmit']) )
{
	...
	{
		//echo "month: ". $OptMonthName;
		if ( !$examRepo->IsTestExist( 0, $OptSection, $OptMonthName, $_SESSION['portal_sup_name'] ) )
		{
			//							   ($teacherClassId, $testMonth, $testDate, $testName, $totalMarks, $details)
			$response = $examRepo->SaveTest($OptSection, $OptMonthName, $TxtTestDate, $TxtTestName, $TxtTotalMarks, $TxtDetails, TestStatus::$Pending, $_SESSION['portal_sup_name'], $optActive);
...
$OptMonthNames->SetSelectedValue ( $currentMonth );
...
<?php $title = "Add Monthly Test"; include($path."includes.php"); ?>
<style>
label.error {
	color: red;
	font-weight: 500;
							  ...
							  <div class="x_content" style="display: block;">
								<br>
									 ...
									 <section id="secNew">
									  ...
									  <div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<?php if($tSections->rowsCount() > 0) $OptSections->Bind(); ?>
								  ...
								  <div class="form-group">
									...
									<?php if($tSections->rowsCount() > 0) { ?>
									  <button type="submit" id="cmdSubmit" name="cmdSubmit" class="btn btn-success">Create</button>
									<?php } ?>
