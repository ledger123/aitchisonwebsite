...
<style>
    .logo-left {
        background-image: url(resources/assets/images/aitchison-logo-new3.svg);
        width: 300px;
        height: 120px;
        top: 60px;
        left: 100px;
...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent nav-home">
    ...
    <!-- <div style="color: #fff; position: absolute; top: 61px; right: 50px; display: block; font-size: 12px; font-weight: 300; margin-left: 84px;">
