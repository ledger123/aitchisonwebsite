...
if (true && in_array($_SESSION['portal_CurrentClass'], ['C1', 'C2'])) {
...
if ( true ) {
	...
	if($studentgroups->rowsCount() > 0) {
        ...
        if ( in_array($_SESSION['portal_School'], ['JSD', 'PSD']) ) {
            if ($groupcycle == "A") {
                $msg_student = "Your classes are scheduled on Monday, Wednesday and Friday.";
            } else {
                $msg_student = "Your classes are scheduled on Tuesday, Thursday and Saturday.";
            }
        ...
        elseif($_SESSION['portal_School'] == "SSD") {
            ...
            $MsgForGroupCylce = '<a href="timetable.php" style=""><div class="alert alert-primary" role="alert" style="color: #000; background-color: #cce5ff; border-color: #b8daff;">                  
                                <div><h3> Routine Programme for Senior School</h3></div>
								<div>WINTER TERM-2020</div>
								<div>Commencing Tuesday 15<sup>th</sup> September, 2020</div>
					  ...
					  <div class="x_content">
						  ...
						  <div class="row">
                              ...
                              <div class="row top_tiles">
                                  <?php if(strlen($get_mock_exam_result_link) > 0) ?>

                                  <div class="row" style="margin-bottom: 15px;">
                                      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">&nbsp;</div>
                                      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">

                                          <?php echo $get_mock_exam_result_link; ?>
							...
							<div class="row top_tiles quick-links">
								...
								<?php if(true) {
								    ...
								    if ($_SESSION['portal_School'] == 'JSD') {
                                        $link = "notice.php?id=877";
                                    }
								    elseif ($_SESSION['portal_School'] == 'PSD') {
                                        $link = "notice.php?id=854";
                                    }
                                    elseif ($_SESSION['portal_School'] == 'SSD') {
