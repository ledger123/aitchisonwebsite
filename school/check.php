<?php
	...
	$page_arr=array(
		...
		"board-of-governors-offline"			=>	"board_of_governors_offline.php",
		...
		"past-principals-offline"		=>	"past_principals-offline.php",
        "code-of-conduct"				=>	"codeofconduct.php",
		"core-purpose"					=>	"core_purpose.php",
		"university-counseling"			=>	"university_counseling.php",
		"university-counseling-offline"			=>	"university_counseling_offline.php",
