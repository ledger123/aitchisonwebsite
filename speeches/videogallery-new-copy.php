...
<html lang="en">
  <head>
    ...
    <title>Aitchison College : Video Gallery</title>
  ...
  <body>
    ...
    <section id="gallery">
      <div class="container">
		  <h2 class="titile">Video Gallery</h2>
		  <br />
        <div class="row">
        	...
        	<div class="videogallery">
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<div class="video-card">
						<a class="voverlay" href="js/video/vdbplayer.swf?volume=100&url=../../../videos/debate-society.mp4" title="Debating Society">
							<img src="../videos/debate-society.jpg" alt="Debating Society" />
						...
						<div class="video-duration"><?php echo time_ago('08/24/2019 08:46'); ?></div>
						
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<div class="video-card">
						<a class="voverlay" href="js/video/vdbplayer.swf?volume=100&url=../../../videos/independence-day-73.mp4" title="Independence Day">
							<img src="videos/independence-day-73.jpg" alt="Independence Day" />
							<span class="video-play"></span>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<div class="video-card">
						...
						<div>Independence Day</div>
						<span>Over the course of Pakistan’s history, Aitchison College has produced some of the country’s finest, including former presidents and prime ministers, sportsmen and renowned artists.</span>
						<div class="video-duration"><?php echo time_ago('08/21/2019'); ?></div>
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<div class="video-card">
						...
						<div>Debating Society</div>
						<span>“Freedom is hammered out on the anvil of discussion, dissent, and debate.”</span>
						<div class="video-duration"><?php echo time_ago('08/17/2019 08:46'); ?></div>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<div class="video-card">
						...
						<div>Independence Day</div>
						<span>Over the course of Pakistan’s history, Aitchison College has produced some of the country’s finest, including former presidents and prime ministers, sportsmen and renowned artists.</span>
						<div class="video-duration"><?php echo time_ago('08/10/2019'); ?></div>
					</div>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<div class="video-card">
						...
						<div>Debating Society</div>
						<span>“Freedom is hammered out on the anvil of discussion, dissent, and debate.”</span>
						<div class="video-duration"><?php echo time_ago('07/23/2019 08:46'); ?></div>
