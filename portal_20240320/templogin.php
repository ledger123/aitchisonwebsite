   ...
   strlen($class) > 1 )
{
	...
	if ( true )
	{
		...
		if(false && (date("Y-m-d") == "2023-07-31" || date("Y-m-d") == "2023-07-31")){
...
function getTemporaryAccessiblePages () {
	...
	$accessiblePages[] = array("pageid"=>"20220815", "url"=>"time-table");
	$accessiblePages[] = array("pageid"=>"20230306", "url"=>"timetable-offline.php");
	...
	$accessiblePages[] = array("pageid"=>"202301071", "url"=>"timetable-offline.php");
	...
	$accessiblePages[] = array("pageid"=>"20230731", "url"=>"fee/fee-bills.php");
	$accessiblePages[] = array("pageid"=>"20230419", "url"=>"offline-link?id=2094");
	$accessiblePages[] = array("pageid"=>"20230504", "url"=>"offline-link?id=2097");
	$accessiblePages[] = array("pageid"=>"202305042", "url"=>"offline-link?id=2098");
	$accessiblePages[] = array("pageid"=>"202305043", "url"=>"offline-link?id=2099");
	$accessiblePages[] = array("pageid"=>"20230505", "url"=>"offline-link?id=2100");

	$accessiblePages[] = array("pageid"=>"202305081", "url"=>"offline-link?id=2103");
	$accessiblePages[] = array("pageid"=>"202305082", "url"=>"offline-link?id=2104");
	$accessiblePages[] = array("pageid"=>"202305083", "url"=>"offline-link?id=2105");
	$accessiblePages[] = array("pageid"=>"20230513", "url"=>"offline-link?id=2110");
	$accessiblePages[] = array("pageid"=>"20230613", "url"=>"offline-link?id=2125");
	$accessiblePages[] = array("pageid"=>"20230706", "url"=>"offline-link?id=2131");
